...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(e,t,n){let r=new Float32Array(oo),i=new q(0,1,0);return new Bi({name:`SphericalGaussianBlur`,defines:{n:oo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function So(){return new Bi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Co(){return new Bi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:wo(),fragmentShader:`
	...
	`}var To=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Xs={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Zs(e,t){let n=Xs[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Qs=new q;function $s(){return Y.getLuminanceCoefficients(Qs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Qs.x.toFixed(4)}, ${Qs.y.toFixed(4)}, ${Qs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
}`,el=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new wi(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new Bi({vertexShader:Qc,fragmentShader:$c,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Z(new Oi(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},tl=class extends Ze{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,u=null,d=null,f=null,p=null,h=null,g=typeof XRWebGLBinding<`u`,_=new el,v={},b=t.getContextAttributes(),x=null,S=null,C=[],D=[],O=new K,k=null,A=new ya;A.viewport=new St;let ee=new ya;ee.viewport=new St;let j=[A,ee],M=new Da,N=null,P=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=C[e];return t===void 0&&(t=new rn,C[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=C[e];return t===void 0&&(t=new rn,C[e]=t),t.getGripSpace()},this.getHand=function(e){let t=C[e];return t===void 0&&(t=new rn,C[e]=t),t.getHandSpace()};function F(e){let t=D.indexOf(e.inputSource);if(t===-1)return;let n=C[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function te(){r.removeEventListener(`select`,F),r.removeEventListener(`selectstart`,F),r.removeEventListener(`selectend`,F),r.removeEventListener(`squeeze`,F),r.removeEventListener(`squeezestart`,F),r.removeEventListener(`squeezeend`,F),r.removeEventListener(`end`,te),r.removeEventListener(`inputsourceschange`,ne);for(let e=0;e<C.length;e++){let t=D[e];t!==null&&(D[e]=null,C[e].disconnect(t))}N=null,P=null,_.reset();for(let e in v)delete v[e];e.setRenderTarget(x),p=null,f=null,d=null,r=null,S=null,le.stop(),n.isPresenting=!1,e.setPixelRatio(k),e.setSize(O.width,O.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&H(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&H(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return f===null?p:f},this.getBinding=function(){return d===null&&g&&(d=new XRWebGLBinding(r,t)),d},this.getFrame=function(){return h},this.getSession=function(){return r},this.setSession=async function(u){if(r=u,r!==null){if(x=e.getRenderTarget(),r.addEventListener(`select`,F),r.addEventListener(`selectstart`,F),r.addEventListener(`selectend`,F),r.addEventListener(`squeeze`,F),r.addEventListener(`squeezestart`,F),r.addEventListener(`squeezeend`,F),r.addEventListener(`end`,te),r.addEventListener(`inputsourceschange`,ne),b.xrCompatible!==!0&&await t.makeXRCompatible(),k=e.getPixelRatio(),e.getSize(O),g&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;b.depth&&(o=b.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=b.stencil?E:T,a=b.stencil?y:m);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};d=this.getBinding(),f=d.createProjectionLayer(s),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),S=new wt(f.textureWidth,f.textureHeight,{format:w,type:l,depthTexture:new Si(f.textureWidth,f.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:b.stencil,colorSpace:e.outputColorSpace,samples:b.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{let n={antialias:b.antialias,alpha:!0,depth:b.depth,stencil:b.stencil,framebufferScaleFactor:i};p=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),S=new wt(p.framebufferWidth,p.framebufferHeight,{format:w,type:l,colorSpace:e.outputColorSpace,stencilBuffer:b.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),le.setContext(r),le.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return _.getDepthTexture()};function ne(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=D.indexOf(n);r>=0&&(D[r]=null,C[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=D.indexOf(n);if(r===-1){for(let e=0;e<C.length;e++)if(e>=D.length){D.push(n),r=e;break}else if(D[e]===null){D[e]=n,r=e;break}if(r===-1)break}let i=C[r];i&&i.connect(n)}}let re=new q,ie=new q;function ae(e,t,n){re.setFromMatrixPosition(t.matrixWorld),ie.setFromMatrixPosition(n.matrixWorld);let r=re.distanceTo(ie),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function oe(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;_.texture!==null&&(_.depthNear>0&&(t=_.depthNear),_.depthFar>0&&(n=_.depthFar)),M.near=ee.near=A.near=t,M.far=ee.far=A.far=n,(N!==M.near||P!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),N=M.near,P=M.far),M.layers.mask=e.layers.mask|6,A.layers.mask=M.layers.mask&-5,ee.layers.mask=M.layers.mask&-3;let i=e.parent,a=M.cameras;oe(M,i);for(let e=0;e<a.length;e++)oe(a[e],i);a.length===2?ae(M,A,ee):M.projectionMatrix.copy(A.projectionMatrix),se(e,M,i)};function se(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=et*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(f===null&&p===null))return s},this.setFoveation=function(e){s=e,f!==null&&(f.fixedFoveation=e),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=e)},this.hasDepthSensing=function(){return _.texture!==null},this.getDepthSensingMesh=function(){return _.getMesh(M)},this.getCameraTexture=function(e){return v[e]};let I=null;function ce(t,i){if(u=i.getViewerPose(c||a),h=i,u!==null){let t=u.views;p!==null&&(e.setRenderTargetFramebuffer(S,p.framebuffer),e.setRenderTarget(S));let i=!1;t.length!==M.cameras.length&&(M.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(p!==null)a=p.getViewport(r);else{let t=d.getViewSubImage(f,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(S,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(S))}let o=j[n];o===void 0&&(o=new ya,o.layers.enable(n),o.viewport=new St,j[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(M.matrix.copy(o.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),i===!0&&M.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&g){d=n.getBinding();let e=d.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&_.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&g){e.state.unbindTexture(),d=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=v[n];e||(e=new wi,v[n]=e);let t=d.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<C.length;e++){let t=D[e],n=C[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}I&&I(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),h=null}let le=new qa;le.setAnimationLoop(ce),this.setAnimationLoop=function(e){I=e},this.dispose=function(){}}},nl=new Dt,rl=new J;rl.set(-1,0,0,0,1,0,0,0,1);function il(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Ii(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(nl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(rl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function al(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return U(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?H(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):H(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var ol=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),sl=null;function cl(){return sl===null&&(sl=new Jr(ol,16,16,k,g),sl.name=`DFG_LUT`,sl.minFilter=o,sl.magFilter=o,sl.wrapS=t,sl.wrapT=t,sl.generateMipmaps=!1,sl.needsUpdate=!0),sl}var ll=class{constructor(e={}){let{canvas:t=We(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:u=!1,powerPreference:d=`default`,failIfMajorPerformanceCaveat:p=!1,reversedDepthBuffer:h=!1,outputBufferType:b=l}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);x=n.getContextAttributes().alpha}else x=a;let S=b,C=new Set([ee,A,O]),w=new Set([l,m,f,y,_,v]),T=new Uint32Array(4),E=new Int32Array(4),D=new q,k=null,j=null,M=[],N=[],P=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let F=this,te=!1,ne=null,re=null,ie=null,ae=null;this._outputColorSpace=Fe;let oe=0,se=0,I=null,ce=-1,le=null,ue=new St,de=new St,fe=null,pe=new X(0),me=0,he=t.width,ge=t.height,_e=1,ve=null,ye=null,be=new St(0,0,he,ge),xe=new St(0,0,he,ge),Se=!1,Ce=new ni,we=!1,Te=!1,Ee=new Dt,De=new q,Oe=new St,ke={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Ae=!1;function je(){return I===null?_e:1}let L=n;function Me(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:p};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,it,!1),t.addEventListener(`webglcontextrestored`,G,!1),t.addEventListener(`webglcontextcreationerror`,K,!1),L===null){let t=`webgl2`;if(L=Me(t,e),L===null)throw Me(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw U(`WebGLRenderer: `+e.message),e}let R,Ne,z,Pe,B,V,Ie,Le,Re,ze,Ve,He,Ue,Ge,qe,Je,Xe,Ze,Qe,$e,et,tt,W;function nt(){R=new Do(L),R.init(),et=new Zc(L,R),Ne=new no(L,R,e,et),z=new Yc(L,R),Ne.reversedDepthBuffer&&h&&z.buffers.depth.setReversed(!0),re=L.createFramebuffer(),ie=L.createFramebuffer(),ae=L.createFramebuffer(),Pe=new Ao(L),B=new kc,V=new Xc(L,R,z,B,Ne,et,Pe),Ie=new Eo(F),Le=new Ja(L),tt=new eo(L,Le),Re=new Oo(L,Le,Pe,tt),ze=new Mo(L,Re,Le,tt,Pe),Ze=new jo(L,Ne,V),qe=new ro(B),Ve=new Oc(F,Ie,R,Ne,tt,qe),He=new il(F,B),Ue=new Nc,Ge=new Bc(R),Xe=new $a(F,Ie,z,ze,x,s),Je=new Jc(F,ze,Ne),W=new al(L,Pe,Ne,z),Qe=new to(L,R,Pe),$e=new ko(L,R,Pe),Pe.programs=Ve.programs,F.capabilities=Ne,F.extensions=R,F.properties=B,F.renderLists=Ue,F.shadowMap=Je,F.state=z,F.info=Pe}nt(),S!==1009&&(P=new Po(S,t.width,t.height,o,r,i));let rt=new tl(F,L);this.xr=rt,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){let e=R.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=R.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return _e},this.setPixelRatio=function(e){e!==void 0&&(_e=e,this.setSize(he,ge,!1))},this.getSize=function(e){return e.set(he,ge)},this.setSize=function(e,n,r=!0){if(rt.isPresenting){H(`WebGLRenderer: Can't change size while VR device is presenting.`);return}he=e,ge=n,t.width=Math.floor(e*_e),t.height=Math.floor(n*_e),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),P!==null&&P.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(he*_e,ge*_e).floor()},this.setDrawingBufferSize=function(e,n,r){he=e,ge=n,_e=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(S===1009){U(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){H(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}P.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(ue)},this.getViewport=function(e){return e.copy(be)},this.setViewport=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),z.viewport(ue.copy(be).multiplyScalar(_e).round())},this.getScissor=function(e){return e.copy(xe)},this.setScissor=function(e,t,n,r){e.isVector4?xe.set(e.x,e.y,e.z,e.w):xe.set(e,t,n,r),z.scissor(de.copy(xe).multiplyScalar(_e).round())},this.getScissorTest=function(){return Se},this.setScissorTest=function(e){z.setScissorTest(Se=e)},this.setOpaqueSort=function(e){ve=e},this.setTransparentSort=function(e){ye=e},this.getClearColor=function(e){return e.copy(Xe.getClearColor())},this.setClearColor=function(){Xe.setClearColor(...arguments)},this.getClearAlpha=function(){return Xe.getClearAlpha()},this.setClearAlpha=function(){Xe.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(I!==null){let t=I.texture.format;e=C.has(t)}if(e){let e=I.texture.type,t=w.has(e),n=Xe.getClearColor(),r=Xe.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(T[0]=i,T[1]=a,T[2]=o,T[3]=r,L.clearBufferuiv(L.COLOR,0,T)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,L.clearBufferiv(L.COLOR,0,E))}else r|=L.COLOR_BUFFER_BIT}t&&(r|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&L.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ne=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,it,!1),t.removeEventListener(`webglcontextrestored`,G,!1),t.removeEventListener(`webglcontextcreationerror`,K,!1),Xe.dispose(),Ue.dispose(),Ge.dispose(),B.dispose(),Ie.dispose(),ze.dispose(),tt.dispose(),W.dispose(),Ve.dispose(),rt.dispose(),rt.removeEventListener(`sessionstart`,ut),rt.removeEventListener(`sessionend`,dt),ft.stop()};function it(e){e.preventDefault(),Ke(`WebGLRenderer: Context Lost.`),te=!0}function G(){Ke(`WebGLRenderer: Context Restored.`),te=!1;let e=Pe.autoReset,t=Je.enabled,n=Je.autoUpdate,r=Je.needsUpdate,i=Je.type;nt(),Pe.autoReset=e,Je.enabled=t,Je.autoUpdate=n,Je.needsUpdate=r,Je.type=i}function K(e){U(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function at(e){let t=e.target;t.removeEventListener(`dispose`,at),ot(t)}function ot(e){st(e),B.remove(e)}function st(e){let t=B.get(e).programs;t!==void 0&&(t.forEach(function(e){Ve.releaseProgram(e)}),e.isShaderMaterial&&Ve.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=ke);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=Ct(e,t,n,r,i);z.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Re.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;tt.setup(i,r,s,n,c);let h,g=Qe;if(c!==null&&(h=Le.get(c),g=$e,g.setIndex(h)),i.isMesh)r.wireframe===!0?(z.setLineWidth(r.wireframeLinewidth*je()),g.setMode(L.LINES)):g.setMode(L.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),z.setLineWidth(e*je()),i.isLineSegments?g.setMode(L.LINES):i.isLineLoop?g.setMode(L.LINE_LOOP):g.setMode(L.LINE_STRIP)}else i.isPoints?g.setMode(L.POINTS):i.isSprite&&g.setMode(L.TRIANGLES);if(i.isBatchedMesh)if(R.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Le.get(c).bytesPerElement:1,o=B.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(L,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function J(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,vt(e,t,n),e.side=0,e.needsUpdate=!0,vt(e,t,n),e.side=2):vt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),j=Ge.get(n),j.init(t),N.push(j),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(j.pushLight(e),e.castShadow&&j.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(j.pushLight(e),e.castShadow&&j.pushShadow(e))}),j.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];J(a,n,e),r.add(a)}else J(t,n,e),r.add(t)}),j=N.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){B.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}R.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ct=null;function lt(e){ct&&ct(e)}function ut(){ft.stop()}function dt(){ft.start()}let ft=new qa;ft.setAnimationLoop(lt),typeof self<`u`&&ft.setContext(self),this.setAnimationLoop=function(e){ct=e,rt.setAnimationLoop(e),e===null?ft.stop():ft.start()},rt.addEventListener(`sessionstart`,ut),rt.addEventListener(`sessionend`,dt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){U(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(te===!0)return;ne!==null&&ne.renderStart(e,t);let n=rt.enabled===!0&&rt.isPresenting===!0,r=P!==null&&(I===null||n)&&P.begin(F,I);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),rt.enabled===!0&&rt.isPresenting===!0&&(P===null||P.isCompositing()===!1)&&(rt.cameraAutoUpdate===!0&&rt.updateCamera(t),t=rt.getCamera()),e.isScene===!0&&e.onBeforeRender(F,e,t,I),j=Ge.get(e,N.length),j.init(t),j.state.textureUnits=V.getTextureUnits(),N.push(j),Ee.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),Ce.setFromProjectionMatrix(Ee,Be,t.reversedDepth),Te=this.localClippingEnabled,we=qe.init(this.clippingPlanes,Te),k=Ue.get(e,M.length),k.init(),M.push(k),rt.enabled===!0&&rt.isPresenting===!0){let e=F.xr.getDepthSensingMesh();e!==null&&pt(e,t,-1/0,F.sortObjects)}pt(e,t,0,F.sortObjects),k.finish(),F.sortObjects===!0&&k.sort(ve,ye,t.reversedDepth),Ae=rt.enabled===!1||rt.isPresenting===!1||rt.hasDepthSensing()===!1,Ae&&Xe.addToRenderList(k,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),we===!0&&qe.beginShadows();let i=j.state.shadowsArray;if(Je.render(i,e,t),we===!0&&qe.endShadows(),(r&&P.hasRenderPass())===!1){let n=k.opaque,r=k.transmissive;if(j.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];ht(n,r,e,a)}Ae&&Xe.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];mt(k,e,n,n.viewport)}}else r.length>0&&ht(n,r,e,t),Ae&&Xe.render(e),mt(k,e,t)}I!==null&&se===0&&(V.updateMultisampleRenderTarget(I),V.updateRenderTargetMipmap(I)),r&&P.end(F),e.isScene===!0&&e.onAfterRender(F,e,t),tt.resetDefaultState(),ce=-1,le=null,N.pop(),N.length>0?(j=N[N.length-1],V.setTextureUnits(j.state.textureUnits),we===!0&&qe.setGlobalState(F.clippingPlanes,j.state.camera)):j=null,M.pop(),k=M.length>0?M[M.length-1]:null,ne!==null&&ne.renderEnd()};function pt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)j.pushLightProbeGrid(e);else if(e.isLight)j.pushLight(e),e.castShadow&&j.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||Ce.intersectsSprite(e)){r&&Oe.setFromMatrixPosition(e.matrixWorld).applyMatrix4(Ee);let t=ze.update(e),i=e.material;i.visible&&k.push(e,t,i,n,Oe.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||Ce.intersectsObject(e))){let t=ze.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Oe.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Oe.copy(e.boundingSphere.center)),Oe.applyMatrix4(e.matrixWorld).applyMatrix4(Ee)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&k.push(e,t,s,n,Oe.z,o)}}else i.visible&&k.push(e,t,i,n,Oe.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)pt(i[e],t,n,r)}function mt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;j.setupLightsView(n),we===!0&&qe.setGlobalState(F.clippingPlanes,n),r&&z.viewport(ue.copy(r)),i.length>0&&gt(i,t,n),a.length>0&&gt(a,t,n),o.length>0&&gt(o,t,n),z.buffers.depth.setTest(!0),z.buffers.depth.setMask(!0),z.buffers.color.setMask(!0),z.setPolygonOffset(!1)}function ht(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(j.state.transmissionRenderTarget[r.id]===void 0){let e=R.has(`EXT_color_buffer_half_float`)||R.has(`EXT_color_buffer_float`);j.state.transmissionRenderTarget[r.id]=new wt(1,1,{generateMipmaps:!0,type:e?g:l,minFilter:c,samples:Math.max(4,Ne.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Y.workingColorSpace})}let a=j.state.transmissionRenderTarget[r.id],o=r.viewport||ue;a.setSize(o.z*F.transmissionResolutionScale,o.w*F.transmissionResolutionScale);let s=F.getRenderTarget(),u=F.getActiveCubeFace(),d=F.getActiveMipmapLevel();F.setRenderTarget(a),F.getClearColor(pe),me=F.getClearAlpha(),me<1&&F.setClearColor(16777215,.5),F.clear(),Ae&&Xe.render(n);let f=F.toneMapping;F.toneMapping=0;let p=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),j.setupLightsView(r),we===!0&&qe.setGlobalState(F.clippingPlanes,r),gt(e,n,r),V.updateMultisampleRenderTarget(a),V.updateRenderTargetMipmap(a),R.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,_t(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(V.updateMultisampleRenderTarget(a),V.updateRenderTargetMipmap(a))}F.setRenderTarget(s,u,d),F.setClearColor(pe,me),p!==void 0&&(r.viewport=p),F.toneMapping=f}function gt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&_t(o,t,n,s,l,c)}}function _t(e,t,n,r,i,a){e.onBeforeRender(F,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(F,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,F.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,F.renderBufferDirect(n,t,r,i,e,a),i.side=2):F.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(F,t,n,r,i,a)}function vt(e,t,n){t.isScene!==!0&&(t=ke);let r=B.get(e),i=j.state.lights,a=j.state.shadowsArray,o=i.state.version,s=Ve.getParameters(e,i.state,a,t,n,j.state.lightProbeGridArray),c=Ve.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ie.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,at),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return bt(e,s),d}else s.uniforms=Ve.getUniforms(e),ne!==null&&e.isNodeMaterial&&ne.build(e,n,s),e.onBeforeCompile(s,F),d=Ve.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=qe.uniform),bt(e,s),r.needsLights=Et(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=j.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function yt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=Vs.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function bt(e,t){let n=B.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function xt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function Ct(e,t,n,r,i){t.isScene!==!0&&(t=ke),V.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=I===null?F.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:Y.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ie.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(h=F.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=B.get(r),y=j.state.lights;if(we===!0&&(Te===!0||e!==le)){let t=e===le&&r.id===ce;qe.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==qe.numPlanes||v.numIntersection!==qe.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=j.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=vt(r,t,i),ne&&r.isNodeMaterial&&ne.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(z.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==ce&&(ce=r.id,C=!0),v.needsLights){let e=xt(j.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||le!==e){z.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(L,`projectionMatrix`,e.projectionMatrix),T.setValue(L,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(L,De.setFromMatrixPosition(e.matrixWorld)),Ne.logarithmicDepthBuffer&&T.setValue(L,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(L,`isOrthographic`,e.isOrthographicCamera===!0),le!==e&&(le=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(L,`directionalShadowMap`,y.state.directionalShadowMap,V),y.state.spotShadowMap.length>0&&T.setValue(L,`spotShadowMap`,y.state.spotShadowMap,V),y.state.pointShadowMap.length>0&&T.setValue(L,`pointShadowMap`,y.state.pointShadowMap,V)),i.isSkinnedMesh){T.setOptional(L,i,`bindMatrix`),T.setOptional(L,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(L,`boneTexture`,e.boneTexture,V))}i.isBatchedMesh&&(T.setOptional(L,i,`batchingTexture`),T.setValue(L,`batchingTexture`,i._matricesTexture,V),T.setOptional(L,i,`batchingIdTexture`),T.setValue(L,`batchingIdTexture`,i._indirectTexture,V),T.setOptional(L,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(L,`batchingColorTexture`,i._colorsTexture,V));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ze.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(L,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=cl()),C){if(T.setValue(L,`toneMappingExposure`,F.toneMappingExposure),v.needsLights&&Tt(E,w),a&&r.fog===!0&&He.refreshFogUniforms(E,a),He.refreshMaterialUniforms(E,r,_e,ge,j.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}Vs.upload(L,yt(v),E,V)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(Vs.upload(L,yt(v),E,V),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(L,`center`,i.center),T.setValue(L,`modelViewMatrix`,i.modelViewMatrix),T.setValue(L,`normalMatrix`,i.normalMatrix),T.setValue(L,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];W.update(n,x),W.bind(n,x)}}return x}function Tt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Et(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return se},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(e,t,n){let r=B.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),B.get(e.texture).__webglTexture=t,B.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=B.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){I=e,oe=t,se=n;let r=null,i=!1,a=!1;if(e){let o=B.get(e);if(o.__useDefaultFramebuffer!==void 0){z.bindFramebuffer(L.FRAMEBUFFER,o.__webglFramebuffer),ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest,z.viewport(ue),z.scissor(de),z.setScissorTest(fe),ce=-1;return}else if(o.__webglFramebuffer===void 0)V.setupRenderTarget(e);else if(o.__hasExternalTextures)V.rebindTextures(e,B.get(e.texture).__webglTexture,B.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&B.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);V.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=B.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&V.useMultisampledRTT(e)===!1?B.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,ue.copy(e.viewport),de.copy(e.scissor),fe=e.scissorTest}else ue.copy(be).multiplyScalar(_e).floor(),de.copy(xe).multiplyScalar(_e).floor(),fe=Se;if(n!==0&&(r=re),z.bindFramebuffer(L.FRAMEBUFFER,r)&&z.drawBuffers(e,r),z.viewport(ue),z.scissor(de),z.setScissorTest(fe),i){let r=B.get(e.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=B.get(e.textures[t]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=B.get(e.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,t.__webglTexture,n)}ce=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){U(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=B.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){z.bindFramebuffer(L.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(c)){U(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!Ne.textureTypeReadable(l)){U(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&L.readPixels(t,n,r,i,et.convert(c),et.convert(l),a)}finally{let e=I===null?null:B.get(I).__webglFramebuffer;z.bindFramebuffer(L.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=B.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){z.bindFramebuffer(L.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+s),!Ne.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!Ne.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,d),L.bufferData(L.PIXEL_PACK_BUFFER,a.byteLength,L.STREAM_READ),L.readPixels(t,n,r,i,et.convert(l),et.convert(u),0);let f=I===null?null:B.get(I).__webglFramebuffer;z.bindFramebuffer(L.FRAMEBUFFER,f);let p=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Ye(L,p,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,d),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,a),L.deleteBuffer(d),L.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;V.setTexture2D(e,0),L.copyTexSubImage2D(L.TEXTURE_2D,n,0,0,o,s,i,a),z.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=et.convert(t.format),_=et.convert(t.type),v;t.isData3DTexture?(V.setTexture3D(t,0),v=L.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(V.setTexture2DArray(t,0),v=L.TEXTURE_2D_ARRAY):(V.setTexture2D(t,0),v=L.TEXTURE_2D),z.activeTexture(L.TEXTURE0),z.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,t.flipY),z.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),z.pixelStorei(L.UNPACK_ALIGNMENT,t.unpackAlignment);let y=z.getParameter(L.UNPACK_ROW_LENGTH),b=z.getParameter(L.UNPACK_IMAGE_HEIGHT),x=z.getParameter(L.UNPACK_SKIP_PIXELS),S=z.getParameter(L.UNPACK_SKIP_ROWS),C=z.getParameter(L.UNPACK_SKIP_IMAGES);z.pixelStorei(L.UNPACK_ROW_LENGTH,h.width),z.pixelStorei(L.UNPACK_IMAGE_HEIGHT,h.height),z.pixelStorei(L.UNPACK_SKIP_PIXELS,l),z.pixelStorei(L.UNPACK_SKIP_ROWS,u),z.pixelStorei(L.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=B.get(e),r=B.get(t),h=B.get(n.__renderTarget),g=B.get(r.__renderTarget);z.bindFramebuffer(L.READ_FRAMEBUFFER,h.__webglFramebuffer),z.bindFramebuffer(L.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,B.get(e).__webglTexture,i,d+n),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,B.get(t).__webglTexture,a,m+n)),L.blitFramebuffer(l,u,o,s,f,p,o,s,L.DEPTH_BUFFER_BIT,L.NEAREST);z.bindFramebuffer(L.READ_FRAMEBUFFER,null),z.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||B.has(e)){let n=B.get(e),r=B.get(t);z.bindFramebuffer(L.READ_FRAMEBUFFER,ie),z.bindFramebuffer(L.DRAW_FRAMEBUFFER,ae);for(let e=0;e<c;e++)w?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,n.__webglTexture,i),T?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,r.__webglTexture,a),i===0?T?L.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):L.copyTexSubImage2D(v,a,f,p,l,u,o,s):L.blitFramebuffer(l,u,o,s,f,p,o,s,L.COLOR_BUFFER_BIT,L.NEAREST);z.bindFramebuffer(L.READ_FRAMEBUFFER,null),z.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?L.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?L.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):L.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):L.texSubImage2D(L.TEXTURE_2D,a,f,p,o,s,g,_,h);z.pixelStorei(L.UNPACK_ROW_LENGTH,y),z.pixelStorei(L.UNPACK_IMAGE_HEIGHT,b),z.pixelStorei(L.UNPACK_SKIP_PIXELS,x),z.pixelStorei(L.UNPACK_SKIP_ROWS,S),z.pixelStorei(L.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&L.generateMipmap(v),z.unbindTexture()},this.initRenderTarget=function(e){B.get(e).__webglFramebuffer===void 0&&V.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?V.setTextureCube(e,0):e.isData3DTexture?V.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?V.setTexture2DArray(e,0):V.setTexture2D(e,0),z.unbindTexture()},this.resetState=function(){oe=0,se=0,I=null,z.reset(),tt.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Be}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Y._getDrawingBufferColorSpace(e),t.unpackColorSpace=Y._getUnpackColorSpace()}},ul=class e{static createButton(t,n={}){let r=document.createElement(`button`);function i(){let e=null;async function i(n){n.addEventListener(`end`,a),await t.xr.setSession(n),r.textContent=`EXIT VR`,e=n}function a(){e.removeEventListener(`end`,a),r.textContent=`ENTER VR`,e=null}r.style.display=``,r.style.cursor=`pointer`,r.style.left=`calc(50% - 50px)`,r.style.width=`100px`,r.textContent=`ENTER VR`;let o={...n,optionalFeatures:[`local-floor`,`bounded-floor`,`layers`,...n.optionalFeatures||[]]};r.onmouseenter=function(){r.style.opacity=`1.0`},r.onmouseleave=function(){r.style.opacity=`0.5`},r.onclick=function(){e===null?navigator.xr.requestSession(`immersive-vr`,o).then(i):(e.end(),navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)}))},navigator.xr.offerSession!==void 0&&navigator.xr.offerSession(`immersive-vr`,o).then(i).catch(e=>{console.warn(e)})}function a(){r.style.display=``,r.style.cursor=`auto`,r.style.left=`calc(50% - 75px)`,r.style.width=`150px`,r.onmouseenter=null,r.onmouseleave=null,r.onclick=null}function o(){a(),r.textContent=`VR NOT SUPPORTED`}function s(e){a(),console.warn(`Exception when trying to call xr.isSessionSupported`,e),r.textContent=`VR NOT ALLOWED`}function c(e){e.style.position=`absolute`,e.style.bottom=`20px`,e.style.padding=`12px 6px`,e.style.border=`1px solid #fff`,e.style.borderRadius=`4px`,e.style.background=`rgba(0,0,0,0.1)`,e.style.color=`#fff`,e.style.font=`normal 13px sans-serif`,e.style.textAlign=`center`,e.style.opacity=`0.5`,e.style.outline=`none`,e.style.zIndex=`999`}if(`xr`in navigator)return r.id=`VRButton`,r.style.display=`none`,c(r),navigator.xr.isSessionSupported(`immersive-vr`).then(function(t){t?i():o(),t&&e.xrSessionIsGranted&&r.click()}).catch(s),r;{let e=document.createElement(`a`);return window.isSecureContext===!1?(e.href=document.location.href.replace(/^http:/,`https:`),e.innerHTML=`WEBXR NEEDS HTTPS`):(e.href=`https://immersiveweb.dev/`,e.innerHTML=`WEBXR NOT AVAILABLE`),e.style.left=`calc(50% - 90px)`,e.style.width=`180px`,e.style.textDecoration=`none`,c(e),e}}static registerSessionGrantedListener(){if(typeof navigator<`u`&&`xr`in navigator){if(/WebXRViewer\//i.test(navigator.userAgent))return;navigator.xr.addEventListener(`sessiongranted`,()=>{e.xrSessionIsGranted=!0})}}};ul.xrSessionIsGranted=!1,ul.registerSessionGrantedListener();var dl=class{constructor(){this.panels=[],this.closedPanels=new Set,this.dockEl=null,this.dragState=null}init(e=[]){this._createDock();for(let t of e){let e=document.querySelector(t);e&&this._setupPanel(e)}}_createDock(){this.dockEl=document.createElement(`div`),this.dockEl.id=`panel-dock`,this.dockEl.className=`panel-dock`,document.body.appendChild(this.dockEl)}_addToDock(e){let t=document.createElement(`button`);t.className=`panel-dock-item`,t.textContent=e.dataset.panelTitle||e.id||`Panel`,t.title=`恢复 ${t.textContent}`,t.addEventListener(`click`,()=>this._showPanel(e)),e._dockItem=t,this.dockEl.appendChild(t)}_removeFromDock(e){e._dockItem&&=(e._dockItem.remove(),null)}_setupPanel(e){let t=e.querySelector(`h1, h2, h3`),n=t?t.textContent:e.id||`Panel`;e.dataset.panelTitle=n;let r=document.createElement(`div`);r.className=`panel-titlebar`;let i=document.createElement(`span`);i.className=`panel-titlebar-text`,i.textContent=n;let a=document.createElement(`span`);a.className=`panel-titlebar-btns`;let o=this._createBtn(`−`,`最小化`,()=>this._toggleMinimize(e)),s=this._createBtn(`×`,`关闭`,()=>this._closePanel(e));a.appendChild(o),a.appendChild(s),r.appendChild(i),r.appendChild(a),e.insertBefore(r,e.firstChild);let c=document.createElement(`div`);for(c.className=`panel-content`;r.nextSibling;)c.appendChild(r.nextSibling);e.appendChild(c),r.addEventListener(`mousedown`,t=>this._onDragStart(t,e)),r.addEventListener(`touchstart`,t=>this._onDragStart(t,e),{passive:!1}),e._minimized=!1,e._closed=!1,this.panels.push(e)}_createBtn(e,t,n){let r=document.createElement(`button`);return r.textContent=e,r.title=t,r.className=`panel-action-btn`,r.addEventListener(`click`,e=>{e.stopPropagation(),n()}),r.addEventListener(`mousedown`,e=>e.stopPropagation()),r.addEventListener(`touchstart`,e=>e.stopPropagation()),r}_toggleMinimize(e){e._minimized=!e._minimized,e._minimized?e.classList.add(`panel-minimized`):e.classList.remove(`panel-minimized`)}_closePanel(e){e._closed=!0,e.classList.add(`hidden`),this.closedPanels.add(e),this._addToDock(e)}_showPanel(e){e._closed=!1,e.classList.remove(`hidden`),this.closedPanels.delete(e),this._removeFromDock(e),e.style.zIndex=this._nextZIndex()}_onDragStart(e,t){e.preventDefault();let n=e.touches?e.touches[0].clientX:e.clientX,r=e.touches?e.touches[0].clientY:e.clientY,i=t.getBoundingClientRect();this.dragState={panel:t,offsetX:n-i.left,offsetY:r-i.top,startLeft:i.left,startTop:i.top},window.getComputedStyle(t),t.style.left=i.left+`px`,t.style.top=i.top+`px`,t.style.right=`auto`,t.style.bottom=`auto`,t.style.transform=`none`,t.style.position=`fixed`,t.style.zIndex=this._nextZIndex();let a=e=>this._onDragMove(e),o=()=>this._onDragEnd(a,o);document.addEventListener(`mousemove`,a),document.addEventListener(`mouseup`,o),document.addEventListener(`touchmove`,a,{passive:!1}),document.addEventListener(`touchend`,o)}_onDragMove(e){if(!this.dragState)return;e.preventDefault();let t=e.touches?e.touches[0].clientX:e.clientX,n=e.touches?e.touches[0].clientY:e.clientY,r=t-this.dragState.offsetX,i=n-this.dragState.offsetY,a=this.dragState.panel,o=window.innerWidth-a.offsetWidth,s=window.innerHeight-40;r=Math.max(0,Math.min(r,o)),i=Math.max(0,Math.min(i,s)),a.style.left=r+`px`,a.style.top=i+`px`}_onDragEnd(e,t){document.removeEventListener(`mousemove`,e),document.removeEventListener(`mouseup`,t),document.removeEventListener(`touchmove`,e),document.removeEventListener(`touchend`,t),this.dragState=null}_nextZIndex(){return this.panels.reduce((e,t)=>{let n=parseInt(window.getComputedStyle(t).zIndex,10)||5;return Math.max(e,n)},5)+1}},fl=class{constructor(){this.sessionId=crypto?.randomUUID?.()??`session-${Date.now()}`,this.startedAt=new Date().toISOString(),this.events=[]}log(e,t={}){this.events.push({sessionId:this.sessionId,type:e,timestamp:new Date().toISOString(),t:performance.now(),...t})}exportJson(){let e=JSON.stringify({sessionId:this.sessionId,startedAt:this.startedAt,exportedAt:new Date().toISOString(),events:this.events},null,2);this.download(`relativistic-voyager-${this.sessionId}.json`,e,`application/json`)}exportCsv(){let e=[`sessionId`,`timestamp`,`t`,`type`,`beta`,`gamma`,`frame`,`viewMode`,`missionId`,`quizId`,`answerIndex`,`isCorrect`],t=[e.join(`,`)];for(let n of this.events)t.push(e.map(e=>JSON.stringify(n[e]??``)).join(`,`));this.download(`relativistic-voyager-${this.sessionId}.csv`,t.join(`
`),`text/csv`)}download(e,t,n){let r=new Blob([t],{type:n}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=e,document.body.appendChild(a),a.click(),a.remove(),URL.revokeObjectURL(i)}},pl=4.24;function ml(e){return Math.min(.999,Math.max(0,Number.isFinite(e)?e:0))}function hl(e){let t=ml(e);return 1/Math.sqrt(1-t*t)}function gl(e){return 1/hl(e)}function _l(e,t){return e/hl(t)}function vl(e,t){return e/hl(t)}function yl(e,t){let n=ml(t);return n<=1e-4?1/0:e/n}function bl(e,t){let n=yl(e,t);return Number.isFinite(n)?n/hl(t):1/0}function xl(e){let t=ml(e.beta),n=hl(t),r=e.earthDistance??4.24,i=vl(r,t),a=yl(r,t),o=bl(r,t),s=_l(e.earthTime,t),c=gl(t);return{beta:t,gamma:n,earthDistance:r,shipDistance:i,earthTime:e.earthTime,shipTime:s,etaEarth:a,etaShip:o,lengthRatio:c}}function Sl(e,t=3){return Number.isFinite(e)?e.toFixed(t):`--`}function Cl(e){return Number.isFinite(e)?e>1e3?`${e.toExponential(2)} years`:`${e.toFixed(2)} years`:`--`}var wl=class{constructor(e){this.state=e,this.el={beta:document.getElementById(`hud-beta`),gamma:document.getElementById(`hud-gamma`),earthTime:document.getElementById(`hud-earth-time`),shipTime:document.getElementById(`hud-ship-time`),earthDistance:document.getElementById(`hud-earth-distance`),shipDistance:document.getElementById(`hud-ship-distance`),eta:document.getElementById(`hud-eta`),lengthRatio:document.getElementById(`hud-length-ratio`),badge:document.getElementById(`mode-badge`)}}update(){let e=xl(this.state);this.el.beta.textContent=Sl(e.beta,3),this.el.gamma.textContent=Sl(e.gamma,3),this.el.earthTime.textContent=Cl(e.earthTime),this.el.shipTime.textContent=Cl(e.shipTime),this.el.earthDistance.textContent=`${Sl(e.earthDistance,2)} ly`,this.el.shipDistance.textContent=`${Sl(e.shipDistance,2)} ly`,this.el.eta.textContent=`${Cl(e.etaEarth)} / ${Cl(e.etaShip)}`,this.el.lengthRatio.textContent=Sl(e.lengthRatio,3),this.el.badge.textContent=`${this.state.viewMode===`measured`?`Measured`:`Observed`} / ${this.state.frame}`}},Tl=class{constructor(e,t){this.state=e,this.logger=t,this.onChange=()=>{}}init(){this.slider=document.getElementById(`speed-slider`),this.frameSelect=document.getElementById(`frame-select`),this.viewModeSelect=document.getElementById(`view-mode-select`),this.pauseBtn=document.getElementById(`pause-btn`),this.resetBtn=document.getElementById(`reset-btn`),this.startBtn=document.getElementById(`start-btn`),this.startBtn.addEventListener(`click`,()=>{document.querySelectorAll(`.hidden`).forEach(e=>e.classList.remove(`hidden`)),document.getElementById(`intro-panel`).classList.add(`hidden`),this.logger.log(`start`)}),this.slider.addEventListener(`input`,()=>{this.state.beta=Number(this.slider.value),this.logger.log(`speed_change`,this.snapshot()),this.onChange()}),document.querySelectorAll(`[data-beta]`).forEach(e=>{e.addEventListener(`click`,()=>{this.state.beta=Number(e.dataset.beta),this.slider.value=String(this.state.beta),this.logger.log(`speed_preset`,this.snapshot()),this.onChange()})}),this.frameSelect.addEventListener(`change`,()=>{this.state.frame=this.frameSelect.value,this.logger.log(`frame_change`,this.snapshot()),this.onChange()}),this.viewModeSelect.addEventListener(`change`,()=>{this.state.viewMode=this.viewModeSelect.value,this.logger.log(`view_mode_change`,this.snapshot()),this.onChange()}),this.pauseBtn.addEventListener(`click`,()=>{this.state.paused=!this.state.paused,this.pauseBtn.textContent=this.state.paused?`继续`:`暂停`,this.logger.log(`pause_toggle`,{paused:this.state.paused,...this.snapshot()})}),this.resetBtn.addEventListener(`click`,()=>{this.state.beta=0,this.state.earthTime=0,this.slider.value=`0`,this.logger.log(`reset`,this.snapshot()),this.onChange()}),document.getElementById(`export-json-btn`).addEventListener(`click`,()=>this.logger.exportJson()),document.getElementById(`export-csv-btn`).addEventListener(`click`,()=>this.logger.exportCsv())}snapshot(){return{beta:this.state.beta,frame:this.state.frame,viewMode:this.state.viewMode}}},El=[{id:`baseline`,title:`任务 1：建立低速直觉基线`,description:`将速度调到 0.1c 左右。观察 γ 是否接近 1，以及地球时间和飞船时间是否几乎相同。`,targetBeta:.1,tolerance:.035,concept:`在低速世界中，相对论效应非常小，因此我们的日常直觉看起来是有效的。`},{id:`time-dilation`,title:`任务 2：观察时间膨胀`,description:`将速度调到 0.8c 以上。比较地球时间和飞船固有时间，观察两者差异如何变大。`,targetBeta:.8,tolerance:.04,concept:`从地球参考系看，高速飞船上的钟走得更慢；飞船乘员经历的是自身固有时间。`},{id:`length-contraction`,title:`任务 3：观察长度收缩`,description:`切换到 Measured 模式，并将速度调到 0.9c。观察测量杆沿运动方向的收缩。`,targetBeta:.9,tolerance:.04,requiredMode:`measured`,concept:`长度收缩是参考系中的测量结果，不是简单的视觉压扁。`},{id:`observed-mode`,title:`任务 4：区分测量与观察`,description:`切换到 Observed 模式。比较视觉观察效果与 Measured 模式下的物理测量结果。`,requiredMode:`observed`,targetBeta:.9,tolerance:.08,concept:`观察到的图像还会受到光传播时间、方向和视角影响，因此不完全等同于测量值。`},{id:`frame-switching`,title:`任务 5：比较参考系`,description:`切换到并列比较模式。比较地球参考系距离和飞船参考系距离的差异。`,targetBeta:.99,tolerance:.02,requiredFrame:`sideBySide`,concept:`同一段旅程在不同参考系下可以有不同的时间和距离描述，但这些描述并不互相矛盾。`}],Dl=class{constructor(e,t){this.state=e,this.logger=t,this.index=0,this.completed=new Set,this.title=document.getElementById(`mission-title`),this.description=document.getElementById(`mission-description`),this.progressBar=document.querySelector(`#mission-progress span`),this.nextBtn=document.getElementById(`next-mission-btn`)}init(){this.nextBtn.addEventListener(`click`,()=>{this.index=(this.index+1)%El.length,this.logger.log(`mission_next`,{missionId:this.current().id}),this.render()}),this.render()}current(){return El[this.index]}evaluate(){let e=this.current(),t=0;if(typeof e.targetBeta==`number`){let n=Math.abs(this.state.beta-e.targetBeta);t+=Math.max(0,1-n/(e.tolerance*4))}else t+=.5;e.requiredMode&&(t+=+(this.state.viewMode===e.requiredMode)),e.requiredFrame&&(t+=+(this.state.frame===e.requiredFrame));let n=1+ +!!e.requiredMode+ +!!e.requiredFrame,r=Math.min(1,t/n);return r>=.95&&!this.completed.has(e.id)&&(this.completed.add(e.id),this.logger.log(`mission_complete`,{missionId:e.id,beta:this.state.beta,frame:this.state.frame,viewMode:this.state.viewMode})),r}update(){let e=this.evaluate();this.progressBar.style.width=`${Math.round(e*100)}%`,e>=.95&&(this.description.innerHTML=`${this.current().description}<br><strong>完成：</strong>${this.current().concept}`)}render(){let e=this.current();this.title.textContent=e.title,this.description.textContent=e.description,this.progressBar.style.width=`0%`}},Ol={1:`现象层：当速度接近光速时，你会看到星空向前方集中、颜色发生偏移，地球时间与飞船时间开始明显分离。`,2:`直观解释层：相对论不是说世界变得混乱，而是不同观察者会用不同的时间和距离描述同一段旅程。`,3:`公式层：γ = 1 / √(1 − β²)。当 β 越接近 1，γ 越大，时间膨胀和长度收缩越明显。`,4:`参考系层：Measured 模式强调参考系中的测量结果；Observed 模式强调观察者接收到光信号后的视觉图像。二者相关但不相同。`},kl=class{constructor(e){this.logger=e,this.text=document.getElementById(`concept-text`),this.buttons=[...document.querySelectorAll(`#concept-tabs [data-level]`)],this.level=1}init(){this.buttons.forEach(e=>{e.addEventListener(`click`,()=>{this.level=Number(e.dataset.level),this.buttons.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),this.logger.log(`concept_level_change`,{level:this.level}),this.render()})}),this.render()}render(){this.text.textContent=Ol[this.level]}},Al=[{id:`q-time-dilation`,question:`当飞船以 0.9c 飞行时，从地球参考系看，飞船上的钟会怎样？`,options:[`飞船上的钟走得更慢`,`飞船上的钟走得更快`,`两个钟完全一样，没有任何差异`,`飞船上的钟停止不动`],answer:0,feedback:`正确理解是：从地球参考系看，高速飞船上的钟走得更慢。但飞船乘员自己不会觉得自己的钟异常。`},{id:`q-length`,question:`长度收缩更准确地说是什么？`,options:[`物体真的被压坏了`,`某一参考系中对运动物体长度的测量结果变短`,`肉眼看到的普通透视效果`,`计算错误造成的假象`],answer:1,feedback:`长度收缩是参考系相关的测量结果。视觉观察还会受到光传播时间和观察角度影响。`},{id:`q-frame`,question:`为什么系统需要地球参考系和飞船参考系切换？`,options:[`因为两个参考系中物理规律完全不同`,`因为相对论的核心是不同观察者对时间和距离的描述不同`,`因为这样画面更炫酷`,`因为飞船参考系是真实的，地球参考系是假的`],answer:1,feedback:`狭义相对论强调不同惯性参考系中物理规律一致，但对时间、距离和同时性的描述可能不同。`},{id:`q-c-limit`,question:`为什么速度滑块不能超过 1c？`,options:[`因为界面没有设计好`,`因为有质量的物体不能被加速到或超过光速`,`因为超过光速后就没有视觉效果`,`因为浏览器性能不够`],answer:1,feedback:`在狭义相对论中，有质量物体不能被加速到光速。越接近光速，γ 越大。`}],jl=class{constructor(e,t){this.state=e,this.logger=t,this.index=0,this.questionEl=document.getElementById(`quiz-question`),this.optionsEl=document.getElementById(`quiz-options`),this.feedbackEl=document.getElementById(`quiz-feedback`),this.nextBtn=document.getElementById(`next-quiz-btn`)}init(){this.nextBtn.addEventListener(`click`,()=>{this.index=(this.index+1)%Al.length,this.logger.log(`quiz_next`,{quizId:this.current().id}),this.render()}),this.render()}current(){return Al[this.index]}render(){let e=this.current();this.questionEl.textContent=e.question,this.optionsEl.innerHTML=``,this.feedbackEl.textContent=``,e.options.forEach((e,t)=>{let n=document.createElement(`button`);n.textContent=e,n.addEventListener(`click`,()=>this.answer(t)),this.optionsEl.appendChild(n)})}answer(e){let t=this.current(),n=e===t.answer;this.feedbackEl.textContent=`${n?`✓ 正确。`:`✗ 需要再想想。`}${t.feedback}`,this.logger.log(`quiz_answer`,{quizId:t.id,answerIndex:e,isCorrect:n,beta:this.state.beta,frame:this.state.frame,viewMode:this.state.viewMode})}};function Ml(){let e=Math.random()*2-1,t=Math.random()*Math.PI*2,n=Math.sqrt(1-e*e);return new q(n*Math.cos(t),n*Math.sin(t),e).normalize()}function Nl(){let e=(Math.random()-.5)*.35,t=Math.random()*Math.PI*2,n=Math.sqrt(1-e*e);return new q(n*Math.cos(t),e,n*Math.sin(t)).normalize()}function Pl(e,t){let n=Math.random(),r=e*e*e+n*(t*t*t-e*e*e);return Math.cbrt(r)}function Fl(){let e=[[.6,.7,1],[.7,.8,1],[.85,.9,1],[.95,.95,.9],[1,.95,.7],[1,.75,.5],[1,.55,.4]],t=Math.random(),n;n=t<.05?0:t<.12?1:t<.32?2:t<.5?3:t<.66?4:t<.85?5:6;let r=e[n];return[r[0]+(Math.random()-.5)*.1,r[1]+(Math.random()-.5)*.1,r[2]+(Math.random()-.5)*.1]}var Il=class{constructor({count:e=8e3,radius:t=3e3}={}){this.count=e,this.outerRadius=t,this.innerRadius=5,this.layers=[],this._createVolumeStars(Math.floor(e*.5),this.innerRadius,t,.6,1.5,.92),this._createVolumeStars(Math.floor(e*.25),this.innerRadius,t,1.5,3.2,1),this._createVolumeStars(Math.floor(e*.1),this.innerRadius,t,3.2,6.5,1),this._createMilkyWayVolume(Math.floor(e*.8),this.innerRadius,t),this.container=new tn;for(let e of this.layers)this.container.add(e.points)}_createVolumeStars(e,t,n,r,i,a=.85){let o=(r+i)/2,s=new Float32Array(e*3),c=new Float32Array(e*3);for(let r=0;r<e;r++){let e=Ml(),i=Pl(t,n);s[r*3]=e.x*i,s[r*3+1]=e.y*i,s[r*3+2]=e.z*i;let a=Fl();c[r*3]=a[0],c[r*3+1]=a[1],c[r*3+2]=a[2]}let l=new ir;l.setAttribute(`position`,new Un(s,3)),l.setAttribute(`color`,new Un(c,3));let u=new pi({size:o,vertexColors:!0,transparent:!0,opacity:a,depthWrite:!1,blending:2,sizeAttenuation:!0});this.layers.push({points:new vi(l,u),count:e})}_createMilkyWayVolume(e,t,n){let r=new Float32Array(e*3),i=new Float32Array(e*3);for(let a=0;a<e;a++){let e=Math.random()<.65?Nl():Ml(),o=Pl(t*.6,n*1.05);r[a*3]=e.x*o,r[a*3+1]=e.y*o,r[a*3+2]=e.z*o;let s=Fl();i[a*3]=s[0],i[a*3+1]=s[1],i[a*3+2]=s[2]}let a=new ir;a.setAttribute(`position`,new Un(r,3)),a.setAttribute(`color`,new Un(i,3));let o=new pi({size:.9,vertexColors:!0,transparent:!0,opacity:.65,depthWrite:!1,blending:2,sizeAttenuation:!0});this.milkyWayPoints=new vi(a,o),this.layers.push({points:this.milkyWayPoints,count:e})}addTo(e){e.add(this.container)}setCenter(e,t,n){}update(e){let t=performance.now()*.001;if(this.layers[2]){let e=.92+.08*Math.sin(t*3.7+123.4);this.layers[2].points.material.opacity=e}this.container.rotation.y+=3e-5}},Ll=class{constructor(){this.group=new tn,this._buildHull(),this._buildNacelles(),this._buildCockpit(),this._buildEngines(),this._buildFlame(),this._buildParticleTrail(),this.group.scale.setScalar(1.2),this._flameTime=0,this._wasThrusting=!1,this._currentPitchX=0}_buildHull(){let e=new tn,t=new Z(new Ei(.16,.24,1.6,12),new Hi({color:13621503,roughness:.3,metalness:.4}));t.rotation.x=Math.PI/2;let n=new Ti(.08,1.3,.06),r=new Hi({color:15265535,roughness:.25,metalness:.5}),i=new Z(n,r);i.position.y=.18;let a=new Z(new Ti(.14,1,.04),r);a.position.y=-.16;let o=new Z(new Di(.18,.5,16),new Hi({color:16777215,roughness:.2,metalness:.3}));o.rotation.x=-Math.PI/2,o.position.z=-1.05;for(let t=0;t<4;t++){let n=t/4*Math.PI*2,r=new Z(new Ti(.005,1.3,.02),new Pr({color:3359846}));r.position.x=Math.cos(n)*.17,r.position.y=Math.sin(n)*.17,e.add(r)}e.add(t,i,a,o),this.hullGroup=e,this.group.add(e)}_buildNacelles(){let e=new Hi({color:10467327,roughness:.4,metalness:.3}),t=new Hi({color:16777215,roughness:.25,metalness:.4});[-1,1].forEach(n=>{let r=new tn,i=new Z(new Ei(.07,.08,.9,12),e);i.rotation.x=Math.PI/2,r.add(i);let a=new Z(new Di(.07,.2,12),t);a.rotation.x=-Math.PI/2,a.position.z=-.55,r.add(a);let o=new Z(new Ei(.07,.06,.1,12),e);o.rotation.x=Math.PI/2,o.position.z=.5,r.add(o),r.position.set(n*.32,-.06,.15),this.group.add(r);let s=new Z(new Ti(.03,.15,.3),new Hi({color:8952268,roughness:.35,metalness:.35}));s.position.set(n*.32,-.12,.15),this.group.add(s)})}_buildCockpit(){let e=new tn,t=new Z(new Ai(.11,16,8,0,Math.PI*2,0,Math.PI/2),new Hi({color:8965375,roughness:.1,metalness:.2,transparent:!0,opacity:.55}));t.rotation.x=-Math.PI/2,t.position.y=.2,t.position.z=-.5;let n=new Z(new ji(.11,.015,8,16),new Hi({color:13421789,roughness:.3,metalness:.6}));n.position.copy(t.position),n.rotation.x=Math.PI/2,e.add(t,n),this.group.add(e)}_buildEngines(){let e=new Hi({color:5596808,roughness:.25,metalness:.7}),t=new Pr({color:4491519,transparent:!0,opacity:.5}),n=new Z(new ji(.14,.04,12,20),e);n.position.z=.88;let r=new Z(new ji(.1,.03,8,16),t);r.position.z=.88,this.group.add(n,r),[-1,1].forEach(t=>{let n=new Z(new ji(.05,.02,8,12),e);n.position.set(t*.32,-.06,.62),this.group.add(n)})}_buildFlame(){let e=new Di(.16,.8,16),t=new Pr({color:6737151,transparent:!0,opacity:0,depthWrite:!1});this.mainFlame=new Z(e,t),this.mainFlame.rotation.x=Math.PI/2,this.mainFlame.position.z=1.2,this.mainFlame.visible=!1;let n=new Di(.08,1,12),r=new Pr({color:16775392,transparent:!0,opacity:0,depthWrite:!1});this.innerFlame=new Z(n,r),this.innerFlame.rotation.x=Math.PI/2,this.innerFlame.position.z=1.25,this.innerFlame.visible=!1;let i=new Di(.22,1.2,16),a=new Pr({color:4495871,transparent:!0,opacity:0,depthWrite:!1});this.outerFlame=new Z(i,a),this.outerFlame.rotation.x=Math.PI/2,this.outerFlame.position.z=1.3,this.outerFlame.visible=!1,this.group.add(this.mainFlame,this.innerFlame,this.outerFlame)}_buildParticleTrail(){let e=new Float32Array(360),t=new Float32Array(360);for(let n=0;n<120;n++)e[n*3]=(Math.random()-.5)*.35,e[n*3+1]=(Math.random()-.5)*.35,e[n*3+2]=1.6+Math.random()*5,t[n*3]=.4+Math.random()*.3,t[n*3+1]=.6+Math.random()*.4,t[n*3+2]=1;let n=new ir;n.setAttribute(`position`,new Un(e,3)),n.setAttribute(`color`,new Un(t,3));let r=new pi({size:.04,vertexColors:!0,transparent:!0,opacity:0,depthWrite:!1,blending:2});this.trailPoints=new vi(n,r),this.trailBasePositions=new Float32Array(e),this.trailPoints.visible=!1,this.group.add(this.trailPoints)}addTo(e){e.add(this.group)}setWorldPosition(e,t,n){this.group.position.set(e,t,n)}getWorldPosition(e){return e.copy(this.group.position)}setHeading(e){this.group.rotation.y=e}getForwardDirection(e){return e.set(0,0,-1),e.applyQuaternion(this.group.quaternion),e}update(e,t=!1,n=0){this._flameTime+=.016;let r=n*.35,i=-e*.12+r;if(this._currentPitchX+=(i-this._currentPitchX)*.12,this.group.rotation.x=this._currentPitchX,t){this.mainFlame.visible=!0,this.innerFlame.visible=!0,this.outerFlame.visible=!0,this.trailPoints.visible=!0;let t=this._flameTime,n=1+Math.sin(t*18.7)*.15+Math.sin(t*23.3+2.1)*.12+Math.sin(t*31.1+4.5)*.08+Math.sin(t*41.7+1.3)*.05,r=1+Math.sin(t*15.3+1.5)*.1+Math.sin(t*27.9+3.2)*.07,i=n*1;this.mainFlame.scale.set(1+Math.sin(t*22)*.08,i*(.7+e*1.5),1+Math.cos(t*19)*.08),this.mainFlame.material.opacity=Math.min(.7,.35+i*.5);let a=r*1;this.innerFlame.scale.set(1+Math.sin(t*25)*.05,a*(.5+e*1.2),1+Math.cos(t*21)*.05),this.innerFlame.material.opacity=Math.min(.8,.4+a*.55);let o=n*.5+.5,s=.5+o*.5,c=.7+o*.3,l=.85+(1-o)*.15;this.mainFlame.material.color.setRGB(s,c,l),this.outerFlame.scale.set(1+Math.sin(t*14)*.1,i*(.6+e*1),1+Math.cos(t*12)*.1),this.outerFlame.material.opacity=Math.min(.35,.1+i*.35)}else{let e=.15;this.mainFlame.material.opacity=Math.max(0,this.mainFlame.material.opacity-e),this.innerFlame.material.opacity=Math.max(0,this.innerFlame.material.opacity-e),this.outerFlame.material.opacity=Math.max(0,this.outerFlame.material.opacity-e),this.trailPoints.material.opacity=Math.max(0,this.trailPoints.material.opacity-e),this.mainFlame.material.opacity<=.01&&(this.mainFlame.visible=!1,this.innerFlame.visible=!1,this.outerFlame.visible=!1,this.trailPoints.visible=!1),this.mainFlame.scale.set(.3,.3,.3),this.innerFlame.scale.set(.2,.2,.2),this.outerFlame.scale.set(.3,.3,.3)}if(t){let t=this.trailPoints.geometry.attributes.position.array;for(let n=0;n<t.length/3;n++){let r=n/(t.length/3),i=(this._flameTime*.8+n*.03)%1.5;t[n*3+2]=this.trailBasePositions[n*3+2]+e*8*r+i*4,t[n*3]=this.trailBasePositions[n*3]*(1+e*1.5*r)+Math.sin(i*8+n)*.08,t[n*3+1]=this.trailBasePositions[n*3+1]*(1+e*1.5*r)+Math.cos(i*7+n)*.08}this.trailPoints.geometry.attributes.position.needsUpdate=!0,this.trailPoints.material.opacity=Math.min(.6,.2+e*.5)}}},Rl=class{constructor(e){this.state=e,this.canvas=document.getElementById(`spacetime-canvas`),this.ctx=this.canvas.getContext(`2d`)}update(){let e=this.ctx,t=this.canvas.width,n=this.canvas.height;e.clearRect(0,0,t,n),e.fillStyle=`#07111f`,e.fillRect(0,0,t,n);let r={x:t/2,y:n-36},i=`#9fb7ff`;e.strokeStyle=i,e.lineWidth=1.3,e.beginPath(),e.moveTo(r.x,r.y),e.lineTo(r.x,28),e.moveTo(34,r.y),e.lineTo(t-34,r.y),e.stroke(),e.fillStyle=i,e.font=`13px sans-serif`,e.fillText(`ct`,r.x+8,34),e.fillText(`x`,t-48,r.y-8),e.strokeStyle=`#445b88`,e.setLineDash([5,6]),e.beginPath(),e.moveTo(r.x,r.y),e.lineTo(r.x-115,28),e.moveTo(r.x,r.y),e.lineTo(r.x+115,28),e.stroke(),e.setLineDash([]),e.strokeStyle=`#7dd3fc`,e.lineWidth=3,e.beginPath(),e.moveTo(r.x,r.y),e.lineTo(r.x,36),e.stroke(),e.fillStyle=`#7dd3fc`,e.fillText(`Earth`,r.x+8,52);let a=Math.max(.02,this.state.beta),o=r.y-36,s=r.x+a*115;e.strokeStyle=`#facc15`,e.lineWidth=3,e.beginPath(),e.moveTo(r.x,r.y),e.lineTo(s,36),e.stroke(),e.fillStyle=`#facc15`,e.fillText(`Ship β=${this.state.beta.toFixed(2)}`,Math.min(s+6,t-100),54);let c=Math.min(1,this.state.earthTime/4.24),l=r.y-o*c,u=r.x+a*115*c;e.fillStyle=`#ffffff`,e.beginPath(),e.arc(u,l,5,0,Math.PI*2),e.fill(),e.strokeStyle=this.state.frame===`ship`?`#facc15`:`#7dd3fc`,e.lineWidth=1.5,e.setLineDash([3,4]),e.beginPath(),this.state.frame===`ship`?(e.moveTo(60,l+a*35),e.lineTo(t-60,l-a*35)):(e.moveTo(60,l),e.lineTo(t-60,l)),e.stroke(),e.setLineDash([]),e.fillStyle=`#d7e4ff`,e.font=`12px sans-serif`,e.fillText(this.state.frame===`ship`?`ship-frame simultaneity cue`:`earth-frame simultaneity cue`,16,n-12)}},zl={Mercury:{nameCN:`水星`,nameEN:`Mercury`,type:`岩石行星 (Rocky)`,diameter:`4,879 km`,distSun:`5790 万 km (0.39 AU)`,orbitalPeriod:`88 天`,temperature:`-180°C ~ 430°C`,moons:`0`,fact:`水星是太阳系中最小的行星，也是距离太阳最近的行星，几乎没有大气层。`,color:`#b0ada6`},Venus:{nameCN:`金星`,nameEN:`Venus`,type:`岩石行星 (Rocky)`,diameter:`12,104 km`,distSun:`1.08 亿 km (0.72 AU)`,orbitalPeriod:`225 天`,temperature:`462°C (平均)`,moons:`0`,fact:`金星是太阳系中最热的行星，浓厚的二氧化碳大气层造成了极端的温室效应。`,color:`#e8d5a3`},Earth:{nameCN:`地球`,nameEN:`Earth`,type:`岩石行星 (Rocky)`,diameter:`12,742 km`,distSun:`1.496 亿 km (1 AU)`,orbitalPeriod:`365.25 天`,temperature:`-89°C ~ 57°C`,moons:`1`,fact:`地球是已知唯一存在生命的天体，拥有液态水和适宜的大气层。`,color:`#4488ff`},Mars:{nameCN:`火星`,nameEN:`Mars`,type:`岩石行星 (Rocky)`,diameter:`6,779 km`,distSun:`2.279 亿 km (1.52 AU)`,orbitalPeriod:`687 天`,temperature:`-140°C ~ 20°C`,moons:`2 (Phobos, Deimos)`,fact:`火星因其表面氧化铁而呈现红色，拥有太阳系中最大的火山——奥林帕斯山。`,color:`#e0553d`},Jupiter:{nameCN:`木星`,nameEN:`Jupiter`,type:`气态巨行星 (Gas Giant)`,diameter:`139,820 km`,distSun:`7.786 亿 km (5.2 AU)`,orbitalPeriod:`11.86 年`,temperature:`-108°C (云顶)`,moons:`95+`,fact:`木星是太阳系中最大的行星，大红斑是一个持续数百年的巨型风暴。`,color:`#d4b896`},Saturn:{nameCN:`土星`,nameEN:`Saturn`,type:`气态巨行星 (Gas Giant)`,diameter:`116,460 km`,distSun:`14.34 亿 km (9.54 AU)`,orbitalPeriod:`29.46 年`,temperature:`-139°C (云顶)`,moons:`146+`,fact:`土星以壮观的环系统闻名，主要由冰碎片、岩石碎片和尘埃组成。`,color:`#e8d5a0`},Uranus:{nameCN:`天王星`,nameEN:`Uranus`,type:`冰巨行星 (Ice Giant)`,diameter:`50,724 km`,distSun:`28.71 亿 km (19.2 AU)`,orbitalPeriod:`84.01 年`,temperature:`-197°C (云顶)`,moons:`27`,fact:`天王星的自转轴几乎平躺在公转平面上（倾斜约 98°），像一个滚动的球。`,color:`#88ccdd`},Neptune:{nameCN:`海王星`,nameEN:`Neptune`,type:`冰巨行星 (Ice Giant)`,diameter:`49,244 km`,distSun:`44.95 亿 km (30.05 AU)`,orbitalPeriod:`164.8 年`,temperature:`-201°C (云顶)`,moons:`16`,fact:`海王星是太阳系中风速最快的行星，风速可达 2,100 km/h。`,color:`#3366cc`}},Bl=100,Vl=class{constructor(){this.group=new tn,this.planets=[],this.orbits=[],this.labels=[],this.moon=null,this._orbitSpeedMultiplier=.08,this._createSun(),this._createPlanets(),this._createMoon(),this._createOrbits(),this._createLabels()}set orbitSpeedMultiplier(e){this._orbitSpeedMultiplier=Math.max(0,Math.min(2,e))}get orbitSpeedMultiplier(){return this._orbitSpeedMultiplier}_createSun(){let e=new tn,t=1.2*Bl,n=this._generateSunTexture(),r=new Z(new Ai(t,64,32),new Pr({map:n}));e.add(r);let i=new Ai(t*1.12,48,24),a=new Pr({color:16763972,transparent:!0,opacity:.2,depthWrite:!1});e.add(new Z(i,a));let o=new Ai(t*1.35,32,16),s=new Pr({color:16750882,transparent:!0,opacity:.08,depthWrite:!1});e.add(new Z(o,s));for(let t=0;t<3;t++){let n=this._makeGlowSprite(16764006,(3+t*1.2)*Bl,.12-t*.03);e.add(n)}e.position.set(0,0,0),this.sunGroup=e,this.group.add(e)}_generateSunTexture(){let e=document.createElement(`canvas`);e.width=512,e.height=256;let t=e.getContext(`2d`),n=t.createRadialGradient(512/2,256/2,0,512/2,256/2,512/2);n.addColorStop(0,`#fffbe6`),n.addColorStop(.3,`#ffe08a`),n.addColorStop(.6,`#ffb833`),n.addColorStop(.85,`#ff8800`),n.addColorStop(1,`#e65500`),t.fillStyle=n,t.fillRect(0,0,512,256);for(let e=0;e<300;e++){let e=Math.random()*512,n=Math.random()*256,r=Math.random()*8+1,i=Math.random()*.25;t.fillStyle=Math.random()>.5?`rgba(255,255,220,${i})`:`rgba(200,100,0,${i})`,t.beginPath(),t.arc(e,n,r,0,Math.PI*2),t.fill()}for(let e=0;e<8;e++){let e=Math.random()*512*.7+512*.15,n=Math.random()*256*.6+256*.2,r=Math.random()*14+4;t.fillStyle=`rgba(80,30,0,0.5)`,t.beginPath(),t.arc(e,n,r,0,Math.PI*2),t.fill(),t.fillStyle=`rgba(40,10,0,0.6)`,t.beginPath(),t.arc(e,n,r*.5,0,Math.PI*2),t.fill()}return new xi(e)}_makeGlowSprite(e,t,n){let r=document.createElement(`canvas`);r.width=128,r.height=128;let i=r.getContext(`2d`),a=i.createRadialGradient(64,64,0,64,64,64);a.addColorStop(0,`rgba(255,220,100,${n})`),a.addColorStop(.3,`rgba(255,180,40,${n*.6})`),a.addColorStop(.7,`rgba(255,120,10,${n*.1})`),a.addColorStop(1,`rgba(255,80,0,0)`),i.fillStyle=a,i.fillRect(0,0,128,128);let o=new wr(new ur({map:new xi(r),blending:2,depthWrite:!1,transparent:!0}));return o.scale.set(t,t,1),o}_createPlanets(){let e=[{name:`Mercury`,radius:.08,orbit:2,roughness:.7,metalness:.15,speed:4.8,texGen:`mercury`},{name:`Venus`,radius:.16,orbit:3.2,roughness:.25,metalness:.05,speed:3.5,texGen:`venus`},{name:`Earth`,radius:.17,orbit:4.6,roughness:.4,metalness:.05,speed:2.9,texGen:`earth`,hasAtmo:!0},{name:`Mars`,radius:.1,orbit:6,roughness:.65,metalness:.1,speed:2.4,texGen:`mars`},{name:`Jupiter`,radius:.48,orbit:8.5,roughness:.45,metalness:.05,speed:1.3,texGen:`jupiter`},{name:`Saturn`,radius:.4,orbit:11,roughness:.35,metalness:.05,speed:.95,texGen:`saturn`,hasRings:!0},{name:`Uranus`,radius:.26,orbit:13.8,roughness:.25,metalness:.05,speed:.68,texGen:`uranus`,tilt:Math.PI/2*.85},{name:`Neptune`,radius:.25,orbit:16.2,roughness:.25,metalness:.05,speed:.55,texGen:`neptune`}];for(let t of e){let e=new tn;e.name=t.name;let n=t.radius*Bl,r=t.orbit*Bl,i=this[`_generate`+t.texGen.charAt(0).toUpperCase()+t.texGen.slice(1)+`Texture`],a=new Hi({map:typeof i==`function`?i.call(this):null,roughness:t.roughness,metalness:t.metalness}),o=new Z(new Ai(n,64,32),a);if(o.castShadow=!0,e.add(o),t.hasAtmo){let t=new Ai(n*1.08,48,24),r=new Pr({color:8961023,transparent:!0,opacity:.1,depthWrite:!1});e.add(new Z(t,r))}if(t.hasRings){let t=new Z(new ki(n*1.4,n*2.2,128),new Pr({map:this._generateRingTexture(),side:2,transparent:!0,opacity:.7,depthWrite:!1}));t.rotation.x=-Math.PI/2,t.rotation.y=.4,e.add(t);let r=new Z(new ki(n*1.55,n*1.9,128),new Pr({color:14535816,side:2,transparent:!0,opacity:.3,depthWrite:!1}));r.rotation.x=-Math.PI/2,r.rotation.y=.4,e.add(r)}t.tilt&&(e.rotation.z=t.tilt);let s=Math.random()*Math.PI*2;e.position.set(Math.cos(s)*r,0,Math.sin(s)*r),this.group.add(e),this.planets.push({group:e,mesh:o,orbitRadius:r,speed:t.speed,angle:s,name:t.name,def:t})}}_generateMercuryTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#b8b5ae`),r.addColorStop(.3,`#a8a59e`),r.addColorStop(.5,`#bab7b0`),r.addColorStop(.7,`#a09d96`),r.addColorStop(1,`#b0ada6`),n.fillStyle=r,n.fillRect(0,0,512,256);for(let e=0;e<12;e++){let e=Math.random()*512,t=Math.random()*256,r=Math.random()*70+25,i=Math.random()*40+15;n.fillStyle=`rgba(100,98,92,0.3)`,n.beginPath(),n.ellipse(e,t,r,i,Math.random()*Math.PI,0,Math.PI*2),n.fill()}for(let e=0;e<200;e++){let e=Math.random()*512,t=Math.random()*256,r=Math.random()*8+1,i=Math.random()>.4;n.strokeStyle=i?`rgba(210,205,195,0.7)`:`rgba(140,135,125,0.6)`,n.lineWidth=Math.random()*1.5+.3,n.beginPath(),n.arc(e,t,r,0,Math.PI*2),n.stroke(),n.fillStyle=i?`rgba(190,185,175,0.3)`:`rgba(120,115,105,0.25)`,n.beginPath(),n.arc(e-r*.15,t-r*.15,r*.7,0,Math.PI*2),n.fill()}for(let e=0;e<15;e++){let e=Math.random()*512,t=Math.random()*256,r=Math.random()*18+6;n.strokeStyle=`rgba(180,175,165,0.8)`,n.lineWidth=2,n.beginPath(),n.arc(e,t,r,0,Math.PI*2),n.stroke(),n.fillStyle=`rgba(170,165,155,0.3)`,n.beginPath(),n.arc(e,t,r*.85,0,Math.PI*2),n.fill(),Math.random()>.5&&(n.fillStyle=`rgba(200,195,185,0.4)`,n.beginPath(),n.arc(e,t,r*.2,0,Math.PI*2),n.fill())}let i=new xi(t);return i.wrapS=i.wrapT=e,i}_generateVenusTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#f0e0c0`),r.addColorStop(.2,`#e8d5a3`),r.addColorStop(.5,`#f2e0b8`),r.addColorStop(.8,`#e5d0a0`),r.addColorStop(1,`#ecd8b0`),n.fillStyle=r,n.fillRect(0,0,512,256);for(let e=0;e<256;e+=2)n.fillStyle=`rgba(255,240,210,${.06+Math.abs(Math.sin(e*.04))*.08})`,n.fillRect(0,e,512,1);for(let e=0;e<30;e++){let e=Math.random()*256,t=Math.random()*8+2,r=Math.random()*.15;n.fillStyle=Math.random()>.5?`rgba(255,245,225,${r})`:`rgba(200,180,140,${r})`,n.fillRect(0,e,512,t)}for(let e=0;e<40;e++){let e=Math.random()*512,t=Math.random()*256,r=Math.random()*25+8;n.strokeStyle=`rgba(255,245,220,0.12)`,n.lineWidth=2,n.beginPath();for(let i=0;i<Math.PI*2;i+=.1){let a=r+Math.sin(i*5)*r*.3,o=e+Math.cos(i)*a,s=t+Math.sin(i)*a*.6;i===0?n.moveTo(o,s):n.lineTo(o,s)}n.stroke()}let i=new xi(t);return i.wrapS=i.wrapT=e,i}_generateEarthTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#1a5588`),r.addColorStop(.25,`#2266aa`),r.addColorStop(.5,`#3377cc`),r.addColorStop(.75,`#2266aa`),r.addColorStop(1,`#1a5588`),n.fillStyle=r,n.fillRect(0,0,512,256);let i=(e,t)=>{n.fillStyle=t,n.beginPath(),n.moveTo(e[0][0],e[0][1]);for(let t=1;t<e.length;t++)n.lineTo(e[t][0],e[t][1]);n.closePath(),n.fill()};i([[60,30],[140,20],[180,40],[200,70],[170,100],[140,110],[90,95],[50,80],[30,55]],`#5a8a3c`),i([[70,35],[130,28],[165,48],[155,80],[100,85],[60,65],[45,45]],`#6b9a44`),i([[155,110],[170,100],[185,115],[190,140],[175,165],[160,170],[145,155],[140,130]],`#4a8a2a`),i([[160,115],[178,125],[172,150],[158,158],[148,138]],`#5a9a35`),i([[230,30],[270,25],[300,35],[310,50],[280,65],[250,60],[225,45]],`#7aaa50`),i([[240,65],[270,60],[290,70],[295,100],[280,130],[260,145],[245,130],[235,100],[230,80]],`#8aaa40`),i([[240,60],[275,55],[288,68],[265,75],[238,72]],`#c4b070`),i([[310,25],[370,15],[420,20],[450,35],[440,55],[400,65],[350,60],[320,50],[305,40]],`#6d8a3a`),i([[360,60],[375,55],[380,75],[370,90],[355,80]],`#5a8a30`),i([[385,70],[410,65],[420,80],[400,90],[380,85]],`#5a9035`),i([[400,110],[430,105],[445,115],[440,135],[420,140],[400,130],[390,118]],`#c48840`),n.fillStyle=`#f0f4f8`,n.fillRect(0,238,512,18);for(let e=0;e<512;e+=4){let t=14+Math.sin(e*.03)*6+Math.sin(e*.07)*4;n.fillStyle=`rgba(240,245,250,0.7)`,n.fillRect(e,256-t,3,t)}n.fillStyle=`#f2f6fa`,n.fillRect(0,0,512,10);for(let e=0;e<512;e+=3){let t=6+Math.sin(e*.05)*5;n.fillStyle=`rgba(240,245,250,0.6)`,n.fillRect(e,0,2,t)}i([[170,18],[195,12],[210,20],[200,32],[178,28]],`#f0f4f8`),n.fillStyle=`#6a9040`,n.beginPath(),n.ellipse(395,50,6,3,.2,0,Math.PI*2),n.fill();for(let e=0;e<200;e++){let e=Math.random()*512,t=Math.random()*256;n.fillStyle=`rgba(255,255,255,${Math.random()*.25})`,n.beginPath(),n.ellipse(e,t,Math.random()*25+4,Math.random()*3+1,Math.random()*Math.PI,0,Math.PI*2),n.fill()}let a=new xi(t);return a.wrapS=a.wrapT=e,a}_generateMarsTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#d47050`),r.addColorStop(.2,`#e07048`),r.addColorStop(.5,`#d86840`),r.addColorStop(.8,`#e87858`),r.addColorStop(1,`#d06848`),n.fillStyle=r,n.fillRect(0,0,512,256);for(let e=0;e<25;e++){let e=Math.random()*512,t=Math.random()*256,r=Math.random()*60+15,i=Math.random()*30+8;n.fillStyle=`rgba(140,60,30,0.25)`,n.beginPath(),n.ellipse(e,t,r,i,Math.random()*Math.PI,0,Math.PI*2),n.fill()}for(let e=0;e<20;e++){let e=Math.random()*512,t=Math.random()*256,r=Math.random()*50+10,i=Math.random()*25+5;n.fillStyle=`rgba(230,160,120,0.2)`,n.beginPath(),n.ellipse(e,t,r,i,Math.random()*Math.PI,0,Math.PI*2),n.fill()}n.fillStyle=`#f0ece4`,n.fillRect(0,0,512,12);for(let e=0;e<512;e+=2){let t=8+Math.sin(e*.04)*6+Math.sin(e*.1)*3;n.fillStyle=`rgba(245,242,235,0.7)`,n.fillRect(e,0,2,t)}n.fillRect(0,246,512,10);for(let e=0;e<512;e+=2){let t=7+Math.sin(e*.04+1)*5;n.fillStyle=`rgba(245,242,235,0.65)`,n.fillRect(e,256-t,2,t)}for(let e=0;e<80;e++){let e=Math.random()*512,t=Math.random()*256,r=Math.random()*6+1;n.strokeStyle=`rgba(180,100,70,0.5)`,n.lineWidth=1,n.beginPath(),n.arc(e,t,r,0,Math.PI*2),n.stroke(),n.fillStyle=`rgba(200,120,80,0.2)`,n.beginPath(),n.arc(e,t,r*.8,0,Math.PI*2),n.fill()}let i=512*.55,a=256*.4;for(let e=20;e>0;e-=3)n.strokeStyle=`rgba(200,130,90,0.3)`,n.lineWidth=1,n.beginPath(),n.arc(i,a,e,0,Math.PI*2),n.stroke();n.fillStyle=`rgba(220,150,110,0.2)`,n.beginPath(),n.arc(i,a,8,0,Math.PI*2),n.fill();let o=new xi(t);return o.wrapS=o.wrapT=e,o}_generateJupiterTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#d4c0a0`),r.addColorStop(.12,`#c8b088`),r.addColorStop(.2,`#e0ccb0`),r.addColorStop(.3,`#c4a878`),r.addColorStop(.4,`#dcc8a8`),r.addColorStop(.5,`#c8b490`),r.addColorStop(.6,`#d8c4a4`),r.addColorStop(.7,`#bc9c6c`),r.addColorStop(.82,`#d4b890`),r.addColorStop(.9,`#c8a878`),r.addColorStop(1,`#d4c0a0`),n.fillStyle=r,n.fillRect(0,0,512,256);for(let e=0;e<256;e++){let t=Math.sin(e*.3)*.06+Math.sin(e*.7)*.04+Math.sin(e*1.5)*.03+Math.sin(e*2.3)*.02,r=Math.abs(t)*1.5;r>.02&&(n.fillStyle=t>0?`rgba(240,220,180,${r})`:`rgba(160,120,70,${r})`,n.fillRect(0,e,512,2))}for(let e=0;e<60;e++){let t=Math.random()*256;for(let r=0;r<512;r+=4){let i=Math.sin(r*.05+e)*3;n.fillStyle=`rgba(200,160,100,0.1)`,n.fillRect(r,t+i,4,1)}}let i=512*.55,a=256*.38,o=n.createRadialGradient(i,a,0,i,a,22);o.addColorStop(0,`#e89070`),o.addColorStop(.5,`#d07858`),o.addColorStop(.8,`#c87050`),o.addColorStop(1,`rgba(200,160,120,0)`),n.fillStyle=o,n.beginPath(),n.ellipse(i,a,28,14,.05,0,Math.PI*2),n.fill(),n.fillStyle=`#e8a080`,n.beginPath(),n.ellipse(i,a,18,9,.05,0,Math.PI*2),n.fill(),n.fillStyle=`#f0c0a0`,n.beginPath(),n.ellipse(i-2,a-2,8,4,.05,0,Math.PI*2),n.fill();for(let e=0;e<5;e++){let e=Math.random()*512*.6+512*.2,t=Math.random()*256*.6+256*.2,r=Math.random()*6+3;n.fillStyle=`rgba(240,200,160,0.35)`,n.beginPath(),n.ellipse(e,t,r,r*.6,0,0,Math.PI*2),n.fill()}let s=new xi(t);return s.wrapS=s.wrapT=e,s}_generateSaturnTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#f0e0c0`),r.addColorStop(.2,`#e8d5a0`),r.addColorStop(.4,`#f2e4c4`),r.addColorStop(.55,`#e8d5a8`),r.addColorStop(.7,`#f0ddb8`),r.addColorStop(.85,`#e5d0a0`),r.addColorStop(1,`#eedcb0`),n.fillStyle=r,n.fillRect(0,0,512,256);for(let e=0;e<256;e+=2)n.fillStyle=`rgba(220,200,160,${.04+Math.abs(Math.sin(e*.25))*.06})`,n.fillRect(0,e,512,1);for(let e=0;e<20;e++){let e=Math.random()*256;n.fillStyle=`rgba(200,180,140,0.06)`,n.fillRect(0,e,512,Math.random()*5+2)}for(let e=0;e<3;e++){let e=Math.random()*512,t=Math.random()*256;n.fillStyle=`rgba(255,250,240,0.2)`,n.beginPath(),n.ellipse(e,t,Math.random()*6+2,Math.random()*3+1,0,0,Math.PI*2),n.fill()}let i=new xi(t);return i.wrapS=i.wrapT=e,i}_generateRingTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=64;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,512,0);r.addColorStop(0,`rgba(200,180,140,0.1)`),r.addColorStop(.12,`rgba(210,190,150,0.6)`),r.addColorStop(.25,`rgba(180,160,130,0.3)`),r.addColorStop(.35,`rgba(220,200,160,0.75)`),r.addColorStop(.5,`rgba(240,220,180,0.85)`),r.addColorStop(.65,`rgba(200,180,140,0.55)`),r.addColorStop(.78,`rgba(190,170,130,0.3)`),r.addColorStop(.9,`rgba(170,150,110,0.15)`),r.addColorStop(1,`rgba(150,130,90,0.05)`),n.fillStyle=r,n.fillRect(0,0,512,64);for(let e=0;e<512;e+=2)n.fillStyle=`rgba(220,200,160,${.2+Math.sin(e*.1)*.15})`,n.fillRect(e,0,1,64);let i=new xi(t);return i.wrapS=i.wrapT=e,i}_generateUranusTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#b0ddd8`),r.addColorStop(.3,`#a8d8d4`),r.addColorStop(.5,`#b8e0dc`),r.addColorStop(.7,`#a0d4d0`),r.addColorStop(1,`#acdad6`),n.fillStyle=r,n.fillRect(0,0,512,256);for(let e=0;e<256;e+=3)n.fillStyle=`rgba(200,240,235,${.02+Math.abs(Math.sin(e*.15))*.03})`,n.fillRect(0,e,512,1);let i=new xi(t);return i.wrapS=i.wrapT=e,i}_generateNeptuneTexture(){let t=document.createElement(`canvas`);t.width=512,t.height=256;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,256);r.addColorStop(0,`#2848b0`),r.addColorStop(.25,`#3058c0`),r.addColorStop(.5,`#3868d0`),r.addColorStop(.75,`#3058c0`),r.addColorStop(1,`#2848b0`),n.fillStyle=r,n.fillRect(0,0,512,256);for(let e=0;e<15;e++){let e=Math.random()*256;n.fillStyle=`rgba(80,140,220,0.12)`,n.fillRect(0,e,512,Math.random()*8+2)}for(let e=0;e<20;e++){let e=Math.random()*512,t=Math.random()*256;n.fillStyle=`rgba(200,220,250,0.2)`,n.beginPath(),n.ellipse(e,t,Math.random()*30+10,Math.random()*3+1,0,0,Math.PI*2),n.fill()}let i=512*.45,a=256*.4,o=n.createRadialGradient(i,a,0,i,a,15);o.addColorStop(0,`#1838a0`),o.addColorStop(.6,`#2040a8`),o.addColorStop(1,`rgba(40,72,184,0)`),n.fillStyle=o,n.beginPath(),n.ellipse(i,a,18,10,0,0,Math.PI*2),n.fill(),n.fillStyle=`rgba(220,235,255,0.3)`,n.beginPath(),n.ellipse(252.4,a-5,8,3,0,0,Math.PI*2),n.fill();let s=new xi(t);return s.wrapS=s.wrapT=e,s}_createMoon(){let e=this.planets.find(e=>e.name===`Earth`);if(!e)return;let t=e.def.radius*Bl,n=t*.27,r=t*3.5,i=new tn;e.group.add(i);let a=new Z(new Ai(n,32,16),new Hi({map:this._generateMoonTexture(),roughness:.7,metalness:.05}));a.position.set(r,0,0),i.add(a);let o=document.createElement(`canvas`);o.width=128,o.height=32;let s=o.getContext(`2d`);s.fillStyle=`rgba(0,0,0,0)`,s.fillRect(0,0,o.width,o.height),s.font=`bold 18px sans-serif`,s.fillStyle=`#cccccc`,s.textAlign=`center`,s.fillText(`Moon`,64,20);let c=new wr(new ur({map:new xi(o),transparent:!0,depthWrite:!1,depthTest:!1}));c.scale.set(6,1.5,1),c.position.y=n+2,a.add(c),this.moon={pivot:i,mesh:a,orbitRadius:r,angle:Math.random()*Math.PI*2,speed:13}}_generateMoonTexture(){let t=document.createElement(`canvas`);t.width=256,t.height=128;let n=t.getContext(`2d`),r=n.createLinearGradient(0,0,0,128);r.addColorStop(0,`#d5d2cc`),r.addColorStop(.3,`#c8c5bf`),r.addColorStop(.5,`#d0cdc7`),r.addColorStop(.7,`#c2bfb9`),r.addColorStop(1,`#ccc9c3`),n.fillStyle=r,n.fillRect(0,0,256,128);for(let e=0;e<8;e++){let e=Math.random()*256,t=Math.random()*128;n.fillStyle=`rgba(140,138,132,0.35)`,n.beginPath(),n.ellipse(e,t,Math.random()*35+15,Math.random()*20+8,Math.random()*Math.PI,0,Math.PI*2),n.fill()}for(let e=0;e<120;e++){let e=Math.random()*256,t=Math.random()*128,r=Math.random()*5+.8;n.strokeStyle=`rgba(180,178,172,0.6)`,n.lineWidth=.8,n.beginPath(),n.arc(e,t,r,0,Math.PI*2),n.stroke(),n.fillStyle=`rgba(190,188,182,0.2)`,n.beginPath(),n.arc(e,t,r*.75,0,Math.PI*2),n.fill()}let i=new xi(t);return i.wrapS=i.wrapT=e,i}_createOrbits(){for(let e of this.planets){let t=[],n=e.orbitRadius;for(let e=0;e<=256;e++){let r=e/256*Math.PI*2;t.push(new q(Math.cos(r)*n,0,Math.sin(r)*n))}let r=new di(new ir().setFromPoints(t),new ri({color:3364215,transparent:!0,opacity:.3,depthWrite:!1}));this.group.add(r),this.orbits.push(r)}}_createLabels(){for(let e of this.planets){let t=document.createElement(`canvas`);t.width=256,t.height=64;let n=t.getContext(`2d`);n.fillStyle=`rgba(0,0,0,0)`,n.fillRect(0,0,t.width,t.height),n.font=`bold 28px sans-serif`,n.fillStyle=`#ffffff`,n.textAlign=`center`,n.fillText(e.name,128,38);let r=new wr(new ur({map:new xi(t),transparent:!0,depthWrite:!1,depthTest:!1}));r.scale.set(16,4,1),r.position.y=e.def.radius*Bl+3.5,e.group.add(r),e.label=r}}addTo(e){e.add(this.group)}update(e){let t=this._orbitSpeedMultiplier;for(let n of this.planets)n.angle+=e*n.speed*t,n.group.position.x=Math.cos(n.angle)*n.orbitRadius,n.group.position.z=Math.sin(n.angle)*n.orbitRadius,n.mesh.rotation.y+=e*.5*t;this.moon&&(this.moon.angle+=e*this.moon.speed*t,this.moon.pivot.rotation.y=this.moon.angle);let n=1+Math.sin(performance.now()*.001)*.015;this.sunGroup.children[0].scale.setScalar(n)}getEarth(){return this.planets.find(e=>e.name===`Earth`)||null}getSun(){return this.sunGroup}static getInfo(e){return zl[e]||null}};function Hl(e){let t=new Ca(16775406,1.6);e.add(t);let n=new tn,r=new Z(new Ai(3.5,32,16),new Pr({color:16773544}));n.add(r);let i=document.createElement(`canvas`);i.width=128,i.height=128;let a=i.getContext(`2d`),o=a.createRadialGradient(64,64,0,64,64,64);o.addColorStop(0,`rgba(255,241,168,0.5)`),o.addColorStop(.4,`rgba(255,220,100,0.2)`),o.addColorStop(.8,`rgba(255,180,40,0.03)`),o.addColorStop(1,`rgba(0,0,0,0)`),a.fillStyle=o,a.fillRect(0,0,128,128);let s=new wr(new ur({map:new xi(i),blending:2,depthWrite:!1,transparent:!0}));s.scale.set(40,40,1),n.add(s);let c=new xa(16773544,200,80);return c.position.set(0,0,0),n.add(c),n.position.set(0,0,-3e3),e.add(n),{target:r,targetGroup:n}}var Ul=class{constructor(){this.ctx=null,this.initialised=!1,this.osc1=null,this.osc2=null,this.gain1=null,this.gain2=null,this.masterGain=null,this.filter=null,this._targetFreq=55,this._currentFreq=55,this._targetGain=0,this._currentGain=0}init(){if(!this.initialised){try{this.ctx=new(window.AudioContext||window.webkitAudioContext)}catch{console.warn(`EngineAudio: Web Audio API not available`);return}this.masterGain=this.ctx.createGain(),this.masterGain.gain.value=0,this.masterGain.connect(this.ctx.destination),this.filter=this.ctx.createBiquadFilter(),this.filter.type=`lowpass`,this.filter.frequency.value=600,this.filter.Q.value=1.8,this.filter.connect(this.masterGain),this.osc1=this.ctx.createOscillator(),this.osc1.type=`sawtooth`,this.osc1.frequency.value=55,this.gain1=this.ctx.createGain(),this.gain1.gain.value=.12,this.osc1.connect(this.gain1),this.gain1.connect(this.filter),this.osc2=this.ctx.createOscillator(),this.osc2.type=`triangle`,this.osc2.frequency.value=27.5,this.gain2=this.ctx.createGain(),this.gain2.gain.value=.15,this.osc2.connect(this.gain2),this.gain2.connect(this.filter),this.osc1.start(),this.osc2.start(),this.initialised=!0}}update(e,t){if(!this.initialised)return;this._targetFreq=55+e*265;let n=400+e*1200;this._targetGain=e*.15+(t?.04:0);let r=.12;this._currentFreq+=(this._targetFreq-this._currentFreq)*r,this._currentGain+=(this._targetGain-this._currentGain)*r,this.osc1.frequency.value=this._currentFreq,this.osc2.frequency.value=this._currentFreq*.5,this.filter.frequency.value=n,this.masterGain.gain.value=Math.max(0,this._currentGain)}mute(){this.masterGain&&(this.masterGain.gain.value=0),this._currentGain=0,this._targetGain=0}dispose(){if(this.osc1)try{this.osc1.stop()}catch{}if(this.osc2)try{this.osc2.stop()}catch{}this.ctx&&this.ctx.close(),this.initialised=!1}},Wl=new class{constructor(){this.state={beta:0,frame:`earth`,viewMode:`measured`,paused:!1,earthTime:0,earthDistance:pl,timeScale:.025},this.shipPosition=new q(0,.5,200),this.shipHeading=0,this.cameraLocalOffset=new q(0,.4,1.2),this.keys={forward:!1,backward:!1,left:!1,right:!1,up:!1,down:!1,shift:!1,ctrl:!1},this.maxSpeed=30,this.turnRate=1.8,this.cameraLerp=.15,this.betaRampRate=.25,this.verticalSpeed=8,this.currentSpeed=0,this.accelRate=12,this.decelRate=16,this.engineAudio=new Ul,this.baseFov=65,this.raycaster=new Va,this.mouse=new K,this._smoothCamPos=new q,this.clock=new Wa}init(){this.logger=new fl,this.setupThree(),this.setupScene(),this.setupUi(),this.setupKeyboard(),this.setupMouse(),this.setupResize(),this.logger.log(`app_init`),this.renderer.setAnimationLoop(()=>this.update())}setupThree(){this.scene=new un,this.scene.background=new X(132627),this.camera=new ya(this.baseFov,window.innerWidth/window.innerHeight,.1,8e3),this._smoothCamPos.copy(this.shipPosition).add(this.cameraLocalOffset),this.camera.position.copy(this._smoothCamPos),this.camera.lookAt(this.shipPosition),this.renderer=new ll({antialias:!0,alpha:!1}),this.renderer.setSize(window.innerWidth,window.innerHeight),this.renderer.setPixelRatio(Math.min(2,window.devicePixelRatio||1)),this.renderer.xr.enabled=!0,this.renderer.shadowMap.enabled=!0,document.getElementById(`app-root`).appendChild(this.renderer.domElement),document.body.appendChild(ul.createButton(this.renderer))}setupScene(){this.solarSystem=new Vl,this.solarSystem.addTo(this.scene),this.refs=Hl(this.scene),this.starField=new Il({count:8e3,radius:3e3}),this.starField.addTo(this.scene),this.spacecraft=new Ll,this.spacecraft.group.scale.setScalar(.12),this.spacecraft.addTo(this.scene),this.spacecraft.setWorldPosition(this.shipPosition.x,this.shipPosition.y,this.shipPosition.z)}setupUi(){this.hud=new wl(this.state),this.controlPanel=new Tl(this.state,this.logger),this.controlPanel.onChange=()=>this.onStateChanged(),this.controlPanel.init(),this.missionSystem=new Dl(this.state,this.logger),this.missionSystem.init(),this.conceptPanel=new kl(this.logger),this.conceptPanel.init(),this.quizSystem=new jl(this.state,this.logger),this.quizSystem.init(),this.spacetimeDiagram=new Rl(this.state),this.panelManager=new dl,this.panelManager.init([`#control-panel`,`#hud-panel`,`#mission-panel`,`#concept-panel`,`#quiz-panel`,`#spacetime-panel`,`#log-panel`]);let e=document.getElementById(`orbit-speed-slider`),t=document.getElementById(`orbit-speed-val`);e&&t&&e.addEventListener(`input`,()=>{let n=parseFloat(e.value);this.solarSystem.orbitSpeedMultiplier=n,t.textContent=n.toFixed(2)+`×`}),this.onStateChanged()}setupKeyboard(){window.addEventListener(`keydown`,e=>this._setKey(e.key,!0)),window.addEventListener(`keyup`,e=>this._setKey(e.key,!1))}_setKey(e,t){t&&!this.engineAudio.initialised&&this.engineAudio.init(),(e===`ArrowUp`||e===`w`||e===`W`)&&(this.keys.forward=t),(e===`ArrowDown`||e===`s`||e===`S`)&&(this.keys.backward=t),(e===`ArrowLeft`||e===`a`||e===`A`)&&(this.keys.left=t),(e===`ArrowRight`||e===`d`||e===`D`)&&(this.keys.right=t),(e===`q`||e===`Q`)&&(this.keys.up=t),(e===`e`||e===`E`)&&(this.keys.down=t),e===`Shift`&&(this.keys.shift=t),e===`Control`&&(this.keys.ctrl=t)}setupMouse(){this.renderer.domElement.addEventListener(`click`,e=>{if(e.target.closest(`.panel`)||e.target.closest(`.panel-dock`))return;let t=this.renderer.domElement.getBoundingClientRect();this.mouse.x=(e.clientX-t.left)/t.width*2-1,this.mouse.y=-((e.clientY-t.top)/t.height)*2+1,this.raycaster.setFromCamera(this.mouse,this.camera);let n=this.solarSystem.planets.map(e=>e.mesh),r=this.raycaster.intersectObjects(n);if(r.length>0){let t=r[0].object,n=this.solarSystem.planets.find(e=>e.mesh===t);n&&this._showPlanetInfo(n.name,e.clientX,e.clientY)}else this._hidePlanetInfo()}),window.addEventListener(`keydown`,e=>{e.key===`Escape`&&this._hidePlanetInfo()})}_showPlanetInfo(e,t,n){let r=zl[e];if(!r)return;let i=document.getElementById(`planet-info-card`);i.innerHTML=`
      <div class="planet-info-header">
        <span class="planet-info-name">${r.nameCN} ${r.nameEN}</span>
        <span class="planet-info-type">${r.type}</span>
      </div>
      <div class="planet-info-body">
        <div class="planet-info-row"><span>直径 Diameter</span><span>${r.diameter}</span></div>
        <div class="planet-info-row"><span>与太阳距离</span><span>${r.distSun}</span></div>
        <div class="planet-info-row"><span>公转周期</span><span>${r.orbitalPeriod}</span></div>
        <div class="planet-info-row"><span>温度</span><span>${r.temperature}</span></div>
        <div class="planet-info-row"><span>卫星 Moons</span><span>${r.moons}</span></div>
        <div class="planet-info-fact">💡 ${r.fact}</div>
      </div>
    `;let a=t+16,o=n-260/2;a+300>window.innerWidth-16&&(a=t-300-16),o<16&&(o=16),o+260>window.innerHeight-16&&(o=window.innerHeight-260-16),i.style.left=a+`px`,i.style.top=o+`px`,i.classList.remove(`hidden`)}_hidePlanetInfo(){let e=document.getElementById(`planet-info-card`);e&&e.classList.add(`hidden`)}setupResize(){window.addEventListener(`resize`,()=>{this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)})}_syncBetaSlider(){let e=document.getElementById(`speed-slider`);e&&(e.value=String(Math.round(this.state.beta*1e3)/1e3))}onStateChanged(){let e=xl(this.state);this.logger.log(`state_snapshot`,{beta:e.beta,gamma:e.gamma,frame:this.state.frame,viewMode:this.state.viewMode}),this.hud.update(),this.spacetimeDiagram.update()}update(){let e=Math.min(.05,this.clock.getDelta()),t=xl(this.state);if(!this.state.paused){this.keys.shift&&(this.state.beta=Math.min(.99,this.state.beta+this.betaRampRate*e),this._syncBetaSlider()),this.keys.ctrl&&(this.state.beta=Math.max(0,this.state.beta-this.betaRampRate*1.4*e),this._syncBetaSlider());let t=this.keys.forward?this.state.beta*this.maxSpeed:0;this.currentSpeed<t?(this.currentSpeed+=this.accelRate*e,this.currentSpeed>t&&(this.currentSpeed=t)):this.currentSpeed>t&&(this.currentSpeed-=this.decelRate*e,this.currentSpeed<t&&(this.currentSpeed=t)),this.currentSpeed<5e-4&&(this.currentSpeed=0),this.keys.left&&(this.shipHeading+=this.turnRate*e),this.keys.right&&(this.shipHeading-=this.turnRate*e);let n=new q(-Math.sin(this.shipHeading),0,-Math.cos(this.shipHeading));this.currentSpeed>1e-4&&this.shipPosition.add(n.clone().multiplyScalar(this.currentSpeed*e)),this.keys.backward&&(this.shipPosition.add(n.clone().multiplyScalar(-this.currentSpeed*.6*e)),this.currentSpeed=Math.max(0,this.currentSpeed-this.decelRate*1.5*e)),this.keys.up&&(this.shipPosition.y+=this.verticalSpeed*e),this.keys.down&&(this.shipPosition.y-=this.verticalSpeed*e),this.shipPosition.y=Math.max(-115,Math.min(2e3,this.shipPosition.y));let r=122.5,i=this.shipPosition.length();i<r&&i>.001&&(this.shipPosition.normalize().multiplyScalar(r),this.currentSpeed*=.2);for(let e of this.solarSystem.planets){let t=e.group.position.x,n=e.group.position.z,r=e.def.radius*100+2.5,i=this.shipPosition.x-t,a=this.shipPosition.z-n,o=Math.sqrt(i*i+a*a);if(o<r&&o>.001){let e=i/o,s=a/o;this.shipPosition.x=t+e*r,this.shipPosition.z=n+s*r,this.currentSpeed*=.3}}}this.spacecraft.setWorldPosition(this.shipPosition.x,this.shipPosition.y,this.shipPosition.z),this.spacecraft.setHeading(this.shipHeading),!this.state.paused&&this.currentSpeed>.001&&(this.state.earthTime+=e*this.state.timeScale*Math.max(.2,this.state.beta*12),this.state.earthTime>t.etaEarth&&Number.isFinite(t.etaEarth)&&(this.state.earthTime=0,this.logger.log(`arrival_loop_reset`,{beta:this.state.beta,gamma:t.gamma})));let n=this.cameraLocalOffset.clone();n.applyAxisAngle(new q(0,1,0),this.shipHeading);let r=this.shipPosition.clone().add(n);this._smoothCamPos.lerp(r,this.cameraLerp),this.camera.position.copy(this._smoothCamPos),this.camera.lookAt(this.shipPosition);let i=this.state.beta,a=document.getElementById(`tunnel-vignette`);a&&(a.style.opacity=Math.min(.92,i*1.1)),this.solarSystem&&this.solarSystem.update(e),this.starField.update(this.state.beta);let o=0;this.keys.up&&(o+=1),this.keys.down&&--o,this.spacecraft.update(this.state.beta,this.keys.forward,o),this.state.paused?this.engineAudio.mute():this.engineAudio.update(this.currentSpeed/this.maxSpeed,this.keys.forward),this.hud.update(),this.missionSystem.update(),this.spacetimeDiagram.update(),this.renderer.render(this.scene,this.camera)}};Wl.init(),window.rvApp=Wl;